...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Ponto de entrada, retorno Sispag, para bloquear a baixa do contas a pagar automatico de acordo com a data
TDN			: 
...
If !Empty( dDataBlq )// .And. ( cEmpAnt == '40' ) .And. Upper( AllTrim( GetEnvServer() ) ) == 'P11_TESTED'  
