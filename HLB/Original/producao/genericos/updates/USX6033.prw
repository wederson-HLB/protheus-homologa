...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Cria o parametro MV_PAGJ52 valor minimo para gerar segmento J-52 no cnab sispag.
Autor       : Anderson Arrais	
Data/Hora   : 18/08/2017    
Revisão		:                    
Módulo      : Financeiro
*/

*---------------------*
User Function USX6033()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aadd(aSX6,{xFilial("SX6"),"MV_PAGJ52","N","Valor minimo de para geracao do SEGMENTO J52.","","","","","","","","","1",".1","1","U"})
****************************************************************************************************************************************** 
