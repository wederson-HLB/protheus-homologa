...
Parametros  : Nil
Retorno     : Nil
Objetivos   : Alteração do Parâmetro MV_DEISSBS conforme boletim DSERFIS1-13365 (ticket 5708056)
Autor       : Thomas Moraes
Data/Hora   : 08/11/2019    12:00
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
//Atualizando Parâmetro MV_DEISSBS por filial
DbSelectArea("SX6")
SX6->(DbSetOrder(1))
If SX6->(DbSeek(xFilial("SX6")+"MV_DEISSBS"))
	RecLock("SX6",.F.)
		SX6->X6_CONTEUD := ".T."
	SX6->(MsUnLock())
	cTexto += "Atualizado Parametro MV_DEISSBS para Filial: "+NL
Else
	cTexto += "Parâmetro MV_DEISSBS não encontrado para Filial: "+NL
EndIf
