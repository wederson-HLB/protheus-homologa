...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação dos campos C5_NATUREZ , CT1_P_CONT , e alteração do parâmetro MV_1DUPNAT 
Autor       : Rodrigo Bastos
Chamado		: 
Data/Hora   : 29/09/2016
*/
*---------------------*
...
aAdd(aSX3,{"CT1",cOrdem,"CT1_P_CONT"	   		,"C",20,0,"Cd Conta Cli"	,"Cd Conta Cli"	,"Cd Conta Cli"	,"Cd Conta Cli"			,"Cd Conta Cli"	,"Cd Conta Cli","@!","Ctb020cta()",'€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","","1","A","",'',"","","","","","","","","","N"})
...
For i:= 1 To Len(aSX6)
	...
	ElseIf !Empty( aSX6[i][10])
		RecLock("SX6",.F.)
			...
			SX6->X6_CONTSPA:= aSX6[i][10]
			SX6->X6_CONTENG:=aSX6[i][10]
		DbCommit()
		MsUnlock() 
