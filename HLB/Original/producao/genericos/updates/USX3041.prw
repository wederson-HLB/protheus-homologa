...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do campo N1_P_OBS
Autor       : Renato Rezende
Chamado		: 020398
Data/Hora   : 01/08/2014
*/
*---------------------*
User Function USX3041()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
DbSelectArea("SX3")
SX3->(DbSetOrder(2))
If !(SX3->(DbSeek("N1_P_OBS")))
	RecLock("SX3",.T.)
	SX3->X3_ARQUIVO		:= "SN1"
	SX3->X3_ORDEM		:= "23"
	SX3->X3_CAMPO		:= "N1_P_OBS"
	SX3->X3_TIPO		:= "C"
	SX3->X3_TAMANHO		:= 200
	SX3->X3_DECIMAL		:= 0
	SX3->X3_TITULO		:= "Observacao"
	SX3->X3_TITSPA		:= "Observacao"
	SX3->X3_TITENG		:= "Observacao"
	SX3->X3_DESCRIC		:= "Observacao"
	SX3->X3_DESCSPA		:= "Observacao"
	SX3->X3_DESCENG		:= "Observacao"
	SX3->X3_PICTURE		:= "@!"
	SX3->X3_USADO		:= "€€€€€€€€€€€€€€ "
	SX3->X3_NIVEL		:= 0
	SX3->X3_RESERV		:= "’A"
	...
	SX3->X3_PYME		:= "N"
	SX3->(MsUnlock())
	cTexto += "Campo Criado: "+SX3->X3_CAMPO+ CHR(13) + CHR(10)
Else
	cTexto += "Campo já Existente: "+SX3->X3_CAMPO+ CHR(13) + CHR(10)
EndIf
