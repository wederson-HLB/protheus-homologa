...
DbSelectArea("SX5")
SX5->(DbSetOrder(1))
//Inclusão do novo CODIGO DE AFASTAMENTO FGTS
...
Else
	cTexto += 'Não foi possivel cadastrar o registro da tabela SX5 30 '+aSX5[1,3]+ CHR(13) + CHR(10)	
EndIf

//Atualizar descrição dos códigos de retenção 5979, 5987 
For i := 2 to 3
	If DbSeek(aSX5[i,1]+aSX5[i,2]+aSX5[i,3])
		...
		MsUnLock()
		cTexto += 'Foi possivel atualizar o código de retenção no SX5 37 :'+aSX5[i,3]+ CHR(13) + CHR(10)
	Else
		cTexto += 'Não foi possivel atualizar o código de retenção no SX5 37 :'+aSX5[i,3] + CHR(13) + CHR(10)	
	EndIf
Next i
