...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Atualização tamanho de campos A5_NOMPROD
Autor       : Anderson Arrais
Chamado		: 
Data/Hora   : 28/11/2018
*/
*---------------------*
User Function USX3080()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
//{SX3} - Campos
//AADD(aSX3,{X3_ARQUIVO,X3_ORDEM,X3_CAMPO,X3_TIPO,X3_TAMANHO,X3_DECIMAL,X3_TITULO,X3_DESCRIC,X3_USADO,X3_NIVEL,X3_RESERV,X3_PROPRI,X3_BROWSE,X3_VISUAL,X3_CONTEXT,X3_PICTURE,X3_GRPSXG})

AADD(aSX3,{'SA5','','A5_NOMPROD','C',cValtoChar(Len(SB1->B1_DESC)),'0','Descricao','Descricao','ÿÿïý€‹ð€€€€€€ƒ€','1','šÀ','','S','V','R','@!',''})
AADD(aArqUpd,'CD8')
