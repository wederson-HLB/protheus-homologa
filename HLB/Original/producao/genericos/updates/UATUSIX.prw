...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Criar .CDX do SIX após migração.
...
Begin Sequence
   ...
   lHistorico	:= MsgYesNo("Deseja efetuar a atualizacao do Dicionário? Esta rotina deve ser utilizada em Çmodo exclusivo."+;
