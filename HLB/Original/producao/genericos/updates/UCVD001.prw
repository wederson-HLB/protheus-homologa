...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Atualizar tabela CVD.
Autor       : Jean Victor Rocha
Data/Hora   : 12/06/2012
*/                            
*---------------------*
User Function UCVD001()
*---------------------*
...
cTexto += "- Efetuado limpeza na tabela CVD com sucesso."+CHR(10)+CHR(13)
