...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Alterar o tamanho do campo W8_CC para 5 caracteres.
Autor       : Renato Rezende
Data/Hora   : 29/04/2013
Revisao     :
Obs.        :
*/  

*--------------------------------*
User Function USX3028(lAmbiente)
*--------------------------------*  
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
SX3->(DbSetOrder(2))
//Alterar o tamanho do campo W8_CC para 5 caracteres.
If SX3->(DBSeek("W8_CC"))
	RecLock("SX3", .F.)
	SX3->X3_TAMANHO := 5
	SX3->(MsUnlock())
	cTexto := " - Campo W8_CC atualizado." 
EndIf
