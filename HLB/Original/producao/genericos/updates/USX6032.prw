...
@version P11
@type function
@description Criação de parametro para controle de destinatario de email para atualização de taxas (WSBACEN)
/*/
*---------------------*
...
Local cAlias     := "" 
	...
	Aadd(aSX6,	 {"  "    ,"MV_P_00104" ,"C"      ,"Destinatario email para atualização de taxas (WSBACEN)","Destinatario email para atualização de taxas (WSBACEN)","Destinatario email para atualização de taxas (WSBACEN)",""        ,""          ,""          ,""        ,""          ,""          ,"rogerio.silva@hlb.com.br,samuel.campbel@hlb.com.br" ,""          ,""          ,"U"        ,"S"      })
