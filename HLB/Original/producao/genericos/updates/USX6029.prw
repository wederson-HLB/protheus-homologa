...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Ajustar os configuradores do calculo de salario maternidade de 180 dias 
Autor       : Richard Steinhauser Busso	
Data/Hora   : 01/02/2017    15:10
Revisão		:                    
Data/Hora   : 
Módulo      : GPE
*/
...
AADD(aSX6,{xFilial("SX6"),"MV_PGSALMA","S","S","S"})
AADD(aSX6,{xFilial("SX6"),"MV_ABATAFA","N","N","N"})
