...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Cria o parametro MV_P_00107 - Parametro com as Empresas que o campo FCI é obrigatório no item do Pedido de Venda
Autor       : Cesar Alves dos Santos
Data/Hora   : 26/10/2017    
Revisão		:                    
Data/Hora   : 
Módulo      : 
*/
...
aadd(aSX6,{xFilial("SX6"),"MV_P_00107","L","Empresas que o campo FCI é obrigatório no item ","Empresas que o campo FCI é obrigatório no item ","Empresas que o campo FCI é obrigatório no item","do Pedido de Venda. Mensagem de Alerta.","do Pedido de Venda. Mensagem de Alerta","do Pedido de Venda. Mensagem de Alerta","","","",".F.","","","U"})
****************************************************************************************************************************************** 
