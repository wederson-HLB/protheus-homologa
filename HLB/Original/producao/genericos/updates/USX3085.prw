...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação de tabela de log de cnab a receber e tabela de mensagem para envio de boleto por email
Autor       : Anderson Arrais
Data/Hora   : 21/05/2019
*/

*---------------------*
User Function USX3085()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
                                           
Private cMessage
Private aArqUpd	 := {"ZX1", "ZX2"}
Private aREOPEN	 := {}
Private oMainWnd
...
AADD(aSix,{'ZX2','1','ZX2_FILIAL+ZX2_COD','Codigo','Codigo','Codigo','U','','','S'})
...
AADD(aSX2,{'ZX2','\SYSTEM\','ZX2'+alltrim(SM0->M0_CODIGO)+'0','Mensagem de cobranca','Mensagem de cobranca','Mensagem de cobranca','','C','C','C','','','','S','','','',''})
...
AADD(aSX3,{'ZX1','10','ZX1_CONV'	,'C','20','','Carteira','Carteira','Carteira','Carteira','Carteira','Carteira','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX2','01','ZX2_FILIAL'	,'C','2','','Filial','Filial','Filial','Filial','Filial','Filial','','','€€€€€€€€€€€€€€€','','','','™€','','','U','N','','','','','','','','','','','033','1','','','','','','','',''})
AADD(aSX3,{'ZX2','02','ZX2_COD'	    ,'C','6','','Codigo','Codigo','Codigo','Codigo','Codigo','Codigo','','','€€€€€€€€€€€€€€ ','IIF(INCLUI,GetSxENum("ZX2","ZX2_COD"),"")','','','ƒ€','','','U','N','V','R','','','','','','','INCLUI','','','1','','','','','','','',''})
AADD(aSX3,{'ZX2','03','ZX2_TITULO'	,'C','30','','Titulo','Titulo','Titulo','Titulo','Titulo','Titulo','@','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX2','04','ZX2_MSG'		,'M','10','','Mensagem','Mensagem','Mensagem','Mensagem','Mensagem','Mensagem','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
