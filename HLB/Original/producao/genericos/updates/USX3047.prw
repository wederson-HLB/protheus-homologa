...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do Update para alteração da descrição do ativo para 100 caracteres N1_DESCRIC. Chamado 023437.
Autor       : Renato Rezende
Chamado		: 
Data/Hora   : 02/01/2015
*/
*---------------------*
User Function USX3047()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
If (SX3->(DbSeek("N1_DESCRIC")))
	...
	Else
		cTexto += "Campo Possui tamanho > ou = a 100: "+SX3->X3_CAMPO+ CHR(13) + CHR(10)
	EndIf
Else
