...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Atualização do parâmetro MV_LENTEN de LENTEN_P.TRM  para LENTEN.TRM
Autor       : João Dos Santos Silva
Data/Hora   : 02/06/2014
Revisao     :
Obs.        :
*/  
*--------------------------------*
User Function USX6020(lAmbiente)
*--------------------------------*  
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aAdd(aDefine, {"MV_LENTAB"	,"LENTAB.TRM"})
