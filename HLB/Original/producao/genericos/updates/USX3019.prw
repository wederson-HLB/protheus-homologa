...
/*
Funcao      : USX3016
Objetivos   : Acerto do X3_RESERV do cmapo Z95_FILIAL (EFD)
Autor       : Jean Victor Rocha
Data/Hora   : 28/06/2012
*/
*----------------------*
User Function USX3019(o)
*----------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aCampos := {{"Z95_FILIAL", "’A"}}

SX3->(DbSetOrder(2))
For i:=1 to len(acampos)
	If SX3->(DBSeek(aCampos[i][1]))
		SX3->(RecLock("SX3", .F.))
		SX3->X3_RESERV := aCampos[i][2]
		SX3->(Msunlock())
		cTexto += "- Campo '"+aCampos[i][1]+"' atualizado Reserv para "+aCampos[i][2]+"."+CHR(10)+CHR(13)
	Else
