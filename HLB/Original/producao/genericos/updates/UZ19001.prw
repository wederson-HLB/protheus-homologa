...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação da tabela com informação do registro I157 ECD
Autor       : Anderson Arrais
Data	    : 30/11/2016
*/

*---------------------*
User Function UZ19001()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
AADD(aSix,{'Z19','1','Z19_FILIAL+Z19_CONTAC+Z19_CONTAG+Z19_SITUA+Z19_DATA','Conta Cliente+Conta GT+Situação+Data','Conta Cliente+Conta GT+Situação+Data','Conta Cliente+Conta GT+Situação+Data','U','','','S'})
...
AADD(aSX2,{'Z19','\SYSTEM\','Z19'+cEmpAnt+'0','Lançamentos I157','Lançamentos I157','Lançamentos I157','','C','C','C','','','','S','','','',''})
...
AADD(aSX3,{'Z19','01','Z19_FILIAL'	,'C','2','','Filial','Filial','Filial','Filial','Filial','Filial','','','€€€€€€€€€€€€€€€','','','','™€','','','U','N','','','','','','','','','','','033','1','','','','','','','',''})
AADD(aSX3,{'Z19','02','Z19_CONTAC'	,'C','20','','Conta Cliente','Conta Cliente','Conta Cliente','Conta Cliente','Conta Cliente','Conta Cliente','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','€','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z19','03','Z19_CONTAG'	,'C','20','','Conta HLB','Conta HLB','Conta HLB','Conta HLB','Conta HLB','Conta HLB','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','€','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z19','04','Z19_CC'		,'C','9','','Centro custo','Centro custo','Centro custo','Centro custo','Centro custo','Centro custo','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z19','05','Z19_VALOR'	,'N','17','2','Valor','Valor','Valor','Valor','Valor','Valor','@E 99,999,999,999,999.99','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z19','06','Z19_SITUA'	,'C','1','','Situa saldo','Situa saldo','Situa saldo','Situa saldo','Situa saldo','Situa saldo','@!','PERTENCE("DC")','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','€','','D=Devedor;C=Credor','D=Devedor;C=Credor','D=Devedor;C=Credor','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z19','07','Z19_DATA'	,'D','8','','Data','Data','Data','Data','Data','Data','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','A','R','€','','','','','','','','','1','','','','','','','',''})
