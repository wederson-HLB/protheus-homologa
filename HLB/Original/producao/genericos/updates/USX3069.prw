...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação dos Campos Customizados para Solaris
Autor       : Renato Rezende
Chamado		: 
Data/Hora   : 29/12/2016
*/
*---------------------*
User Function USX3069()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
AADD(aSX3,{'SD1','','D1_P_FORPG','C','50','0','FormaPagto','Forma de Pagto','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})
AADD(aSX3,{'SD1','','D1_P_IDPRO','N','10','0','NumProtocolo','ID Protocolo','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R','@N 9999999999'})  
AADD(aSX3,{'SD1','','D1_P_DTPRO','D','8','0','DataProtocol','Data Protocolo','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})  
AADD(aSX3,{'SD1','','D1_P_TPDOC','C','10','0','TipoDocument','Tipo Doc','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})  
AADD(aSX3,{'SD1','','D1_P_NDOC','C','10','0','NumDocumento','ID-PP/PC','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})  
AADD(aSX3,{'SD1','','D1_P_CCONT','C','50','0','ContaCorrent','Conta Corrente','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})  
AADD(aSX3,{'SD1','','D1_P_TPTRA','C','50','0','TipoTransaca','Tipo Transação','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})          
AADD(aArqUpd,'SD1')

AADD(aSX3,{'SE2','','E2_P_NDOC','C','10','0','NumDocumento','ID-PP/PC','€€€€€€€€€€€€€€ ','1','‚A','U','N','A','R',''})  
AADD(aSX3,{'SE2','','E2_P_IDPRO','N','10','0','NumProtocolo','ID Protocolo','€€€€€€€€€€€€€€ ','1','‚A','U','S','A','R','@N 9999999999'}) 
AADD(aArqUpd,'SE2') 

//AADD(aSX3,{'SF1','','F1_P_NUMFL','N','8','0','Num.Fluig','Numero Fluig','€€€€€€€€€€€€€€','1','þA','U','N','A','R','@N 99999999'})        
AADD(aSX3,{'SF1','','F1_P_IDPRO','N','10','0','NumProtocolo','ID Protocolo','€€€€€€€€€€€€€€ ','1','‚A','U','S','A','R','@N 9999999999'})  
AADD(aArqUpd,'SF1')
