...
Parametros  : Nil
Retorno     : Nil
Objetivos   : Ajuste nos dados da tabela SEB para corrigir ocorrencias cadastradas para "Pagamentos agendados" estão com o "cod. 03"
Autor       : Cesar Alves
Data/Hora   : 24/08/2020
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
WHILE SEB->(!EOF())
    ...
    If Alltrim(SEB->EB_REFBAN) $ "BD/BE" 
		cOcorrAnt := SEB->EB_OCORR
		RecLock( "SEB" , .F. )
		SEB->EB_OCORR := '02'
		SEB->(MsUnLock())
		cTexto += "Atualizado o campo EB_OCORR " +SEB->EB_REFBAN+ " do banco : " +SEB->EB_BANCO+ " de: " +cOcorrAnt+ " - Para: 02 " +NL	  
	EndIF 
