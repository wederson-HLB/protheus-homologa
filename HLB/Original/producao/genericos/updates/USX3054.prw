...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Alterar tamanho do campo CVB_SEQCRC
Autor       : Jean Victor Rocha
Chamado		: 
Data/Hora   : 27/05/2015
*/
*---------------------*
User Function USX3054()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
For i:=1 to Len(aCampos)
	...
	EndIf                           
	If SX3->(Dbseek(aCampos[i][2])) .and. SX3->X3_TAMANHO < 15
		SX3->(RecLock("SX3", .F.))
		SX3->X3_TAMANHO	:=	15
		SX3->(MsUnlock())
		cTexto += "- Atualizado o campo '"+aCampos[i][2]+CHR(13)+CHR(10)
	EndIf
Next i
