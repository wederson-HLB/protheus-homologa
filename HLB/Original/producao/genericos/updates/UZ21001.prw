...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação da tabela de log no envio de holerite por e-mail
Autor       : Anderson Arrais
Data/Hora   : 13/06/2016
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
*---------------------*
User Function UZ21001()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
                                           
Private cMessage
Private aArqUpd	 := {"Z21" , "SA5"} //AOA - 11/01/2017 - Inclusão da tabela SA5
Private aREOPEN	 := {}
Private oMainWnd
...
AADD(aSX2,{'Z21','\SYSTEM\','Z21'+SM0->M0_CODIGO+'0','Log no envio de holerite por e-mail','Log no envio de holerite por e-mail','Log no envio de holerite por e-mail','','C','C','C','','','','S','','','',''})
...
//AOA - 11/01/2017 - Inclusão de campos na tabela Z21 e campos para tabela SA5

AADD(aSX3,{'Z21','01','Z21_FILIAL'	,'C','2','','Filial','Filial','Filial do Si','Filial','Filial','Filial','','','€€€€€€€€€€€€€€€','','','','™€','','','U','N','','','','','','','','','','','033','1','','','','','','','',''})
AADD(aSX3,{'Z21','02','Z21_DATA'	,'D','8','','Data','Data','Data','Data','Data','Data','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','€','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','03','Z21_HORA'	,'C','8','','Hora Alterac','Hora Alterac','Hora Alterac','Hora Alterac','Hora Alterac','Hora Alterac','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','04','Z21_NOME'	,'C','30','','Nome','Nome','Nome','Nome','Nome','Nome','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','05','Z21_MAT'		,'C','6','','Matricula','Matricula','Matricula','Matricula','Matricula','Matricula','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','06','Z21_EMAIL'	,'C','50','','E-mail','E-mail','E-mail','E-mail','E-mail','E-mail','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','07','Z21_ASSUNT'	,'C','150','','Assunto','Assunto','Assunto','Assunto','Assunto','Assunto','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','08','Z21_REF'		,'C','50','','Mes Ref','Mes Ref','Mes Ref','Mes Ref','Mes Ref','Mes Ref','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','09','Z21_USER'	,'C','30','','User','User','User','User','User','User','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','10','Z21_ID'		,'C','6','','Id. Usuario','Id. Usuario','Id. Usuario','Id. Usuario','Id. Usuario','Id. Usuario','','','€€€€€€€€€€€€€€ ','','','','š€','','S','U','S','V','R','','','','','','','','','','1','','','','','','','',''})
AADD(aSX3,{'Z21','11','Z21_DOC'		,'C','9','','Documento','Documento','Documento','Documento','Documento','Documento','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','','','',''})
AADD(aSX3,{'Z21','12','Z21_SERIE'	,'C','3','','Serie','Serie','Serie','Serie','Serie','Serie','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','','','',''})
AADD(aSX3,{'Z21','13','Z21_STATUS'	,'C','1','','Status','Status','Status','Status','Status','Status','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','','','',''})
AADD(aSX3,{'Z21','14','Z21_LOG'		,'C','10','','Log','Log','Log','Log','Log','Log','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','','','',''})
AADD(aSX3,{'Z21','15','Z21_ARQ'		,'C','50','','Arq','Arq','Arq','Arq','Arq','Arq','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','','','',''})
AADD(aSX3,{'SA5','B4','A5_P_TE'		,'C','3','','TES Entrada ','TES Entrada ','TES Entrada ','TES para importacao XML  ','TES para importacao XML  ','TES para importacao XML  ','@!','','€€€€€€€€€€€€€€ ','','SF4','','þA','','','U','N','A','R','','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'SA5','B5','A5_P_CONV'	,'N','14','4','Conversao UN','Conversao UN','Conversao UN','Conversao UN Forc. Client','Conversao UN Forc. Client','Conversao UN Forc. Client','@E 999,999,999.9999','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'SA5','B6','A5_P_UN'		,'C','2','','UN Medida','UN Medida','UN Medida','Unidade de medida cliente','Unidade de medida cliente','Unidade de medida cliente','','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','V','','','','','','','','','','1','','','','','N','N','',''})
