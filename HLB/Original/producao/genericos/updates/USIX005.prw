...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação do indice CVD_FILIAL+CVD_ENTREF+CVD_CODPLA+CVD_CONTA+CVD_CUSTO na tabela CVD
Autor       : Matheus Massarotto
Data/Hora   : 01/04/2016    10:14
Revisão		:                    
Data/Hora   : 
Módulo      : USIX005
*/
...
AADD(aSix,{'CVD','4','CVD_FILIAL+CVD_ENTREF+CVD_CODPLA+CVD_CONTA+CVD_CUSTO','Entidade + Plano Ref. + Cod Conta + Cod C.Custo','Entidade + Plano Ref. + Cod Conta + Cod C.Custo','Entidade + Plano Ref. + Cod Conta + Cod C.Custo','S','','','S'})
