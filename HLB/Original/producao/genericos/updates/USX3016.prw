...
Data/Hora   : 26/04/2012
*/
*----------------------*
User Function USX3016(o)
*----------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
SX3->(DbSetOrder(2))
If SX3->(DBSeek("A2_COD"))//pega o Reserv de um campo padrão que possui para todos os modulos.
	cReserv := SX3->X3_RESERV
	If SX3->(DBSeek("A2_PAIS"))
		SX3->(RecLock("SX3",.F.))
		SX3->X3_RESERV := cReserv
		SX3->(MsUnlock())
		cTexto := " - Campo A2_COD atualizado." 
	EndIf	
EndIf
