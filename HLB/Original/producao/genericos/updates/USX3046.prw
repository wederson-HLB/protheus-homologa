...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação das tabelas e ajuste na picture do campo B1_PORCPRL para Lei da Transparência.
Autor       : Renato Rezende
Chamado		: 
Data/Hora   : 19/12/2014
*/
*---------------------*
User Function USX3046()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aTab :={"SL1","SL2","SL3","SL4","SL5","SL6","SL7","SL8","SL9","SLA","SLB","SLC","SLD","SLF","SLG","SLH","SLI","SLJ","SLK","SLL","SLM","SLN","SLO","SLP","SLQ",;
		"SLR","SLT","SLV","SLW","SLX","SLZ"}
		
For nR:=1 to len(aTab)
	ChkFile(aTab[nR])
	cTexto+="- Tabela Criada: "+aTab[nR]+CHR(13)+CHR(10)
Next nR

DbSelectArea("SX3")
SX3->(DbSetOrder(2))
If (SX3->(DbSeek("B1_PORCPRL")))
	RecLock("SX3",.F.)
	SX3->X3_CBOX	:= "20=20%;30=30%;40=40%"
	SX3->X3_PICTVAR	:= ""		
	SX3->(MsUnlock())
	cTexto += "Campo Alterado: "+SX3->X3_CAMPO+ CHR(13) + CHR(10)	
Else
	cTexto += "Campo não Existente: "+SX3->X3_CAMPO+ CHR(13) + CHR(10)
EndIf
