...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : atualizar parametros MV_CFAREC com o conteudo "5101, 5102, 5103"
...
*/  
*--------------------------------*
User Function USX6008(lAmbiente)
*--------------------------------*  
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
//JVR - 16/07/2012 - adicionado 5201,5202, chamado 006122
aAdd(aDefine, {"MV_CFAREC"	,"5949,6949,7949"}) 
aAdd(aDefine, {"MV_CFEREC"	,"5201,5202,6201,6202"}) 
