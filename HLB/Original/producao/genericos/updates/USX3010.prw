...
/*
Funcao      : USX3010
Objetivos   : Alteração no tamanho dos campos R2_CBO e R2_TIPOADM
Autor       : Eduardo C. Romanini
Data/Hora   : 05/03/2012
*/
*----------------------*
User Function USX3010(o)
*----------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
SX3->(DbSetOrder(2))
If SX3->(DBSeek("R2_CBO"))
	SX3->(RecLock("SX3",.F.))
	If SX3->X3_TAMANHO <> 6 
		SX3->X3_TAMANHO := 6
		SX3->X3_PICTURE := "999999"
		cTexto := "R2_CBO atualizado." 
...
SX3->(DbSetOrder(2))
If SX3->(DBSeek("R2_TIPOADM"))
	SX3->(RecLock("SX3",.F.))
	If SX3->X3_TAMANHO <> 2 
		SX3->X3_TAMANHO := 2
		SX3->X3_PICTURE := "@!"
		cTexto := "R2_TIPOADM atualizado." 
