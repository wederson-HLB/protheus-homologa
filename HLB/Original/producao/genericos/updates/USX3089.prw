...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Cria��o dos campos CT1_PBIGRP/CT1_PBIDES/CT1_PBITIP/CT1_PBIITE/CT1_PBIMAP para o projeto Power BI
Autor       : C�sar Alves
Data/Hora   : 19/04/2019
*/

*---------------------*
User Function USX3089()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
cOrdem := NextOrdem('CT1')
AADD(aSX3,   {'CT1',	cOrdem  ,'CT1_PBIGRP','C' ,'8'       ,'0'       ,'PBI Grupo' 	,'PBI Grupo'	,'PBI Grupo'	,'PBI Grupo'	,'PBI Grupo'	,'PBI Grupo'	,'@!'      ,''      ,'��������������',''        ,''   ,'0'     ,'��'     ,''      ,''        ,'U'      ,'S'      ,'A'      ,'R'       ,''        ,''        ,''     ,''        ,''        ,''        ,''    ,''       ,''        ,''       ,''     ,''        ,''       ,''       ,'N'       ,'N'      ,''     ,''})

cOrdem := NextOrdem('CT1')
AADD(aSX3,   {'CT1',	cOrdem  ,'CT1_PBIDES','C' ,'100'     ,'0'       ,'PBI Descrica' ,'PBI Descrica'	,'PBI Descrica'	,'PBI Descrica'	,'PBI Descrica'	,'PBI Descrica'	,'@!'      ,''      ,'��������������',''        ,''   ,'0'     ,'��'     ,''      ,''        ,'U'      ,'S'      ,'A'      ,'R'       ,''        ,''        ,''     ,''        ,''        ,''        ,''    ,''       ,''        ,''       ,''     ,''        ,''       ,''       ,'N'       ,'N'      ,''     ,''})

cOrdem := NextOrdem('CT1')
AADD(aSX3,   {'CT1',	cOrdem  ,'CT1_PBITIP','C' ,'100'     ,'0'       ,'PBI Tipo' 	,'PBI Tipo'		,'PBI Tipo'		,'PBI Tipo'		,'PBI Tipo'		,'PBI Tipo'		,'@!'      ,''      ,'��������������',''        ,''   ,'0'     ,'��'     ,''      ,''        ,'U'      ,'S'      ,'A'      ,'R'       ,''        ,''        ,''     ,''        ,''        ,''        ,''    ,''       ,''        ,''       ,''     ,''        ,''       ,''       ,'N'       ,'N'      ,''     ,''})

cOrdem := NextOrdem('CT1')
AADD(aSX3,   {'CT1',	cOrdem  ,'CT1_PBIITE','C' ,'100'     ,'0'       ,'PBI Item' 	,'PBI Item'		,'PBI Item'		,'PBI Item'		,'PBI Item'		,'PBI Item'		,'@!'      ,''      ,'��������������',''        ,''   ,'0'     ,'��'     ,''      ,''        ,'U'      ,'S'      ,'A'      ,'R'       ,''        ,''        ,''     ,''        ,''        ,''        ,''    ,''       ,''        ,''       ,''     ,''        ,''       ,''       ,'N'       ,'N'      ,''     ,''})

cOrdem := NextOrdem('CT1')
AADD(aSX3,   {'CT1',	cOrdem  ,'CT1_PBIMAP','C' ,'100'     ,'0'       ,'PBI De Para' 	,'PBI De Para'	,'PBI De Para'	,'PBI De Para'	,'PBI De Para'	,'PBI De Para'	,'@!'      ,''      ,'��������������',''        ,''   ,'0'     ,'��'     ,''      ,''        ,'U'      ,'S'      ,'A'      ,'R'       ,''        ,''        ,''     ,''        ,''        ,''        ,''    ,''       ,''        ,''       ,''     ,''        ,''       ,''       ,'N'       ,'N'      ,''     ,''})
