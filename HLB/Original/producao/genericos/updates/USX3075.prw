...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Atualização dos campos D1_COD,D1_ITEM,D1_DOC,D1_SERIE,D1_FORNECE,D1_LOJA como USADO
Autor       : Anderson Arrais
Chamado		: 
Data/Hora   : 05/12/2017
*/
*---------------------*
User Function USX3075()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
if SX3->(DbSeek("D1_COD"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_COD no SX3 da tabela SD1 como usado"+NL
endif

SX3->(DbSetOrder(2))
SX3->(DbGotop())
if SX3->(DbSeek("D1_ITEM"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_ITEM no SX3 da tabela SD1 como usado"+NL
endif

SX3->(DbSetOrder(2))
SX3->(DbGotop())
if SX3->(DbSeek("D1_DOC"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_DOC no SX3 da tabela SD1 como usado"+NL
endif

SX3->(DbSetOrder(2))
SX3->(DbGotop())
if SX3->(DbSeek("D1_SERIE"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_SERIE no SX3 da tabela SD1 como usado"+NL
endif

SX3->(DbSetOrder(2))
SX3->(DbGotop())
if SX3->(DbSeek("D1_FORNECE"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_FORNECE no SX3 da tabela SD1 como usado"+NL
endif

SX3->(DbSetOrder(2))
SX3->(DbGotop())
if SX3->(DbSeek("D1_LOJA"))
	Reclock("SX3",.F.)
		SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->(MsUnlock())
	cTexto += "Alterado o campo D1_LOJA no SX3 da tabela SD1 como usado"+NL
endif
