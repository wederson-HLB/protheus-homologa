...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do Update criação do campo C5_P_REF.
Autor       : Renato Rezende
Chamado		: 
Data/Hora   : 05/01/2015
*/
*---------------------*
User Function USX3048()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aAdd(aSX3,{"SC5","","C5_P_REF"	   		,"C",030,0,"Order Ref"	,"Order Ref"	,"Order Ref"	,"Order Reference"			,"Order Reference"			,"Order Reference"			,"@!",'','€€€€€€€€€€€€€€ ',"" ,"",0,'†A',"","","U","N","A","R",'',"","","","","","","","","","N"})
