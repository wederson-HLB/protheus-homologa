...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Cria o parametro MV_P_00109 nas empresas que ainda não possuem o parametro.
...
aadd(aSX6,{xFilial("SX6"),"MV_P_00109","L","Utiliza o numero do Fluig T=Sim F=Nao","Utiliza o numero do Fluig T=Sim F=Nao","Utiliza o numero do Fluig T=Sim F=Nao","","","","","","",".F.",".F.",".F.","U"})
****************************************************************************************************************************************** 
...
//Altera o campo D1_NUMFL deixando o mesmo como não Obrigatório.
DbSelectArea("SX3")
SX3->(DbSetOrder(2))
SX3->(DbSeek("D1_P_NUMFL"))
	...
	cTexto += "Campo Num. Fluig(D1_P_NUMFL) tirado de Obrigatório"
