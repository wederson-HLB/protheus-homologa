...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do Update : Projeto Zoom - Geracao de boleto\Fatura por email
Autor       : Leandro Brito
Chamado		: 
Data/Hora   : 06/11/2015
*/
*---------------------*
User Function USX3058()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil

Private cMessage
Private aArqUpd	 := {"SC5" , "SC6" , "SF2" , "Z25" , "SA1" }
Private aREOPEN	 := {}
Private oMainWnd
...
Aadd( aSix ,{ "Z25" , "1" , "Z25_FILIAL+Z25_USR" , "User" , "User" , "User" , "U" , , "" , "S" } )
...
cOrdem := NextOrdem( 'Z25' )
aAdd(aSX3,{"Z25",cOrdem,"Z25_FILIAL"	   		,"C",2,0,"Filial"	,"Sucursal"	,"Branch"	,"Filial do Sistema"			,"Sucursal"	,"Branch of the System ","@!",'','€€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_ID"	   		,"C",6,0,"ID"	,"ID"	,"ID"	,"ID"			,"ID"	,"ID","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"}) 

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_USR"	   		,"C",30,0,"User"	,"User"	,"User"	,"User"			,"User"	,"User","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_HOUR"	   		,"C",5,0,"Hora"	,"Hora"	,"Hora"	,"Hora"			,"Hora"	,"Hora","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_DATE"	   		,"D",8,0,"Data"	,"Data"	,"Data"	,"Data"			,"Data"	,"Data","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_KEY"	   		,"C",100,0,"Chave"	,"Chave"	,"Chave"	,"Chave"			,"Chave"	,"Chave","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"}) 

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z25",cOrdem,"Z25_OBS"	   		,"C",30,0,"Observacao"	,"Observacao"	,"Observacao"	,"Observacao"			,"Observacao"	,"Observacao","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})

cOrdem := NextOrdem( 'SF2' )
aAdd(aSX3,{"SF2",cOrdem,"F2_P_ENV"	   		,"C",1,0,"Flag Boleto"	,"Flag Boleto"	,"Flag Boleto"	,"Flag Boleto"	,"Flag Boleto"	,"Flag Boleto"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})


If ( cEmpAnt == 'B1' )
	
	cOrdem := NextOrdem( 'SC5' )
	aAdd(aSX3,{"SC5",cOrdem,"C5_P_CP"	   		,"C",1,0,"Tp.Pagamento"	,"Tp.Pagamento"	,"Tp.Pagamento"	,"Tp.Pagamento"	,"Tp.Pagamento"	,"Tp.Pagamento"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})
	
	cOrdem := Soma1( cOrdem )
	aAdd(aSX3,{"SC5",cOrdem,"C5_P_PI"	   		,"C",30,0,"Numero PI"	,"Numero PI"	,"Numero PI"	,"Numero PI"	,"Numero PI"	,"Numero PI"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})
	
	cOrdem := Soma1( cOrdem )
	aAdd(aSX3,{"SC5",cOrdem,"C5_P_OBS"	   		,"C",200,0,"Obs Ad."	,"Obs Ad."	,"Obs Ad."	,"Obs Ad."	,"Obs Ad."	,"Obs Ad."	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})
	
	cOrdem := Soma1( cOrdem )
	aAdd(aSX3,{"SC5",cOrdem,"C5_P_NUMBO"	   		,"C",30,0,"Num.Boleto"	,"Num.Boleto"	,"Num.Boleto"	,"Num.Boleto"	,"Num.Boleto"	,"Num.Boleto"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})
	
	cOrdem := Soma1( cOrdem )
	aAdd(aSX3,{"SC5",cOrdem,"C5_P_TAXA"	   		,"N",TamSX3('M2_MOEDA2')[1],TamSX3('M2_MOEDA2')[2],"Taxa Dolar"	,"Taxa Dolar"	,"Taxa Dolar"	,"Taxa Dolar"	,"Taxa Dolar"	,"Taxa Dolar"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})		
	
	cOrdem := NextOrdem( 'SA1' )
	aAdd(aSX3,{"SA1",cOrdem,"A1_P_ID"	   		,"C",30,0,"Codigo Zoom"	,"Codigo Zoom"	,"Codigo Zoom"	,"Codigo Zoom"	,"Codigo Zoom"	,"Codigo Zoom"	,"@!",'','€€€€€€€€€€€€€€',"" ,"",0,'†A',"","","U","N","V","R",'',"","","","","","","","","","N"})		
		
	SX3->(DbSetOrder(2))
	
	If SX3->( DbSeek( PadR( 'C6_DESCRI' , nLenCampo ) ) ) .And. ( SX3->X3_TAMANHO <> 120 )
		SX3->( RecLock( 'SX3' , .F. ) )
		SX3->X3_TAMANHO := 120
		SX3->( MSUnlock() )
		
		cTexto += "- Campo 'C6_DESCRI' alterado tamanho ( 120 )." + CHR(10) + CHR(13)
		
	EndIf
	
	If SX3->( DbSeek( PadR( 'C5_MENNOTA' , nLenCampo ) ) ).And. ( SX3->X3_TAMANHO <> 120 )
		SX3->( RecLock( 'SX3' , .F. ) )
		SX3->X3_TAMANHO := 120
		SX3->( MSUnlock() )
		cTexto += "- Campo 'C5_MENNOTA' alterado tamanho ( 120 ) ." + CHR(10) + CHR(13)
...
aAdd(aSX6,{"","MV_P_00056","C" ,'Mensagem do contato no corpo do email','Mensagem do contato no corpo do email','Mensagem do contato no corpo do email',""	,;
""	,""	,"do e-mail (faturamento@zoom.com.br)","do e-mail (faturamento@zoom.com.br)","do e-mail (faturamento@zoom.com.br)","U","","",""}) 

aAdd(aSX6,{"","MV_P_00054","C" ,'E-mails que receberam a notificacao de enviado com','E-mails que receberam a notificacao de enviado com','E-mails que receberam a notificacao de enviado com',"sucesso (cliente)"	,;
"sucesso (cliente)"	,"sucesso (cliente)"	,"","","","U","","",""})

aAdd(aSX6,{"","MV_P_00055","C" ,'E-mails que receberam a notificacao de enviado','E-mails que receberam a notificacao de enviado','E-mails que receberam a notificacao de enviado',"com sucesso (HLB)"	,;
"com sucesso (HLB)"	,"com sucesso (HLB)"	,"","","","U","","",""})

aAdd(aSX6,{"","MV_P_00057","C" ,'Funcao de impressao de boleto','Funcao de impressao de boleto','Funcao de impressao de boleto',""	,;
""	,""	,"U_B1FIN001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_PREFIXO)","U_B1FIN001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_PREFIXO)","U_B1FIN001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_PREFIXO)","U","","",""})

aAdd(aSX6,{"","MV_P_00058","C" ,'Funcao de impressao de fatura','Funcao de impressao de fatura','Funcao de impressao de fatura',""	,;
""	,""	,"U_B1FAT001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_SERIE)","U_B1FAT001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_SERIE)","U_B1FAT001(CVER1=='S' , TEMP1->F2_DOC,TEMP1->F2_SERIE)","U","","",""})
