...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : acerto do tamanho de campos.
Autor       : Jean Victor Rocha
Data/Hora   : 17/04/2013 
Revisão		: Alteração dos campos W6_UFDESEM e W6_LOCAL para obrigatórios.
Autor		: Renato Rezende
Data/Hora	: 17/04/2013
*/
*---------------------*
User Function USX3027()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
For i:=1 to Len(aDados)
	...
	If SX3->(DbSeek(cCampo))
		SX3->(RecLock("SX3",.F.))
		SX3->X3_TAMANHO := aDados[i][2]
		SX3->(MsUnlock())		
		cTexto += "Campo '"+AllTrim(cCampo)+"' atualizado com sucesso!" +CHR(13)+CHR(10)
...
//RRP - 17/04/2013 - Campos obrigatórios W6_LOCAL e W6_UFDESEM  
...
If SX3->(DBSeek("W6_LOCAL"))
	...
	SX3->X3_OBRIGAT := '€'
	SX3->(MsUnlock())
	cTexto += " - Campo W6_LOCAL atualizado."+CHR(13)+CHR(10) 
EndIf 

If SX3->(DBSeek("W6_UFDESEM"))
	RecLock("SX3", .F.)
	SX3->X3_OBRIGAT := '€'
	SX3->(MsUnlock())
	cTexto += " - Campo W6_UFDESEM atualizado."+CHR(13)+CHR(10) 
EndIf
