...
Altera��es  : 	06/03/2015 - Leandro Brito - Desenvolvimento da Integracao de Notas Fiscais de Servi�os Prestados  
				06/03/2015 - Leandro Brito - Desenvolvimento Layout Nota Carioca - Servi�os Prestados
				18/09/2015 - Leandro Brito - Desenvolvimento Layout Nota Paulista  - Servi�os Prestados	 
Data        : 25/05/2013
*/                   
*----------------*
Class GTIntNfServ 
...
If ( oGTIntNfServ:cTipoNF == 'T' )  //** servicos Tomados
	...
	//RRP - Inclus�o de filtro por CNPJ no Browser.
	//Filtro Inicial BKP
	aNfsIni := aClone(aNfs)
...
If lAchou
	aNfs:= aClone(aFiltro)
Else
	MsgInfo("Filtro n�o retornou nenhum registo!","HLB BRASIL")
EndIf
