...
Static Function GeraF3()
    *------------------------*
    ...
    Begin Sequence
        ...
        //VITOR.EZ4 incluido o CRIATRAB e o DBUSEAREA para 
        //corrigir uma falha em que o indregua nao localiza a tabela para criar sua INDEX. #21666
        cWork := CriaTrab(aSemSx3, .T.)
        dbUseArea( .T.,"DBFCDX",cWork,"WKMODU", .T., .F. )
