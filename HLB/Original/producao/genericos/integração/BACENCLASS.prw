...
±±∫Programa BACENCLASS∫ Autor ≥ Equipe Desenvolvimento ∫ Data ≥   28/04/10∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥ Programa de integraÁ„o de taxa                             ∫±±
±±∫          ≥                                                            ∫±±
...
/* ===============================================================================
WSDL Location    \wsdl\FachadaWSSGS.wsdl
Gerado em        04/28/10 16:57:44
ObservaÁıes      CÛdigo-Fonte gerado por ADVPL WSDL Client 1.090116
                 AlteraÁıes neste arquivo podem causar funcionamento incorreto
                 e ser„o perdidas caso o cÛdigo-fonte seja gerado novamente.
=============================================================================== */

User Function BACENCLASS ; Return  // "dummy" function - Internal Use 
...
If !FindFunction("XMLCHILDEX")
	UserException("O CÛdigo-Fonte Client atual requer os execut·veis do Protheus Build [7.00.090818P-20100111] ou superior. Atualize o Protheus ou gere o CÛdigo-Fonte novamente utilizando o Build atual.")
EndIf
Return Self
...
cSoap += WSSoapValue("getValoresSeriesVOin0", ::oWSgetValoresSeriesVOin0, oWSgetValoresSeriesVOin0 , "ArrayOfflong", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("in1", ::cin1, cin1 , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("in2", ::cin2, cin2 , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("in0", ::nin0, nin0 , "long", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("in1", ::nin1, nin1 , "long", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("getValoresSeriesXMLin0", ::oWSgetValoresSeriesXMLin0, oWSgetValoresSeriesXMLin0 , "ArrayOfflong", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("in1", ::cin1, cin1 , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("in2", ::cin2, cin2 , "string", .T. , .T. , 0 , NIL, .F.) 
...
WSMETHOD SOAPSEND WSCLIENT FachadaWSSGSService_ArrayOfflong
	Local cSoap := ""
	aEval( ::nlong , {|x| cSoap := cSoap  +  WSSoapValue("long", x , x , "long", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
