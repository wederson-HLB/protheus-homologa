...
TDN			: 	LOCALIZAÇÃO : MATA103(Notas Fiscais de Entrada 
...
//RRP - 03/03/2017 - Alteração Número Protocolo para o grupo Solaris
ElseIf cEmpAnt $ "HH/HJ/IK/"
	aAdd(aRet,{'Num Protocolo', 'U_HHEST003(1)', 0, 5})
EndIf
//RSB - 23/10/2017 - Exibe a tela do numero do Fluig no menu de ações relacionadas.
If lFluig
