...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Relatório Brazil Template PROFIT & LOSS FY (Portal do SQL Reposts)
Autor       : Renato Rezende 
Cliente		: Discovery
Data/Hora   : 31/01/2017
*/                          
*-------------------------*
 User Function 49CTB002()
*-------------------------*
Private titulo		:= "Relatório Brazil Template PL - Discovery"
Private cPerg		:= ""
Private cDest		:= ""
Private cArq		:= "Profit_Loss_Fy_"+GravaData( dDataBase,.F.,6 )+"_"+Substr(TIME(),1,2)+"_"+Substr(TIME(),4,2)+"_"+Substr(TIME(),7,2)+".xls"
Private cQuery		:= ""
...
cQuery+= "	BRAND, " + CRLF
cQuery+= "	PLATFORM, " + CRLF
cQuery+= "	GEOGRAPHY, " + CRLF
cQuery+= "	COMPANY_CODE, " + CRLF
cQuery+= "	COST_CENTER, " + CRLF
cQuery+= "  PRJ, " + CRLF
...
cQuery+= "			CTG_PERIOD IS NOT NULL " + CRLF
cQuery+= " " + CRLF
...
cHtml+= '  </Style>'+ CRLF
cHtml+= ' </Styles>'+ CRLF
cHtml+= ' <Worksheet ss:Name="Brazil Template PL">'+ CRLF
cHtml+= '  <Table ss:ExpandedColumnCount="36" ss:ExpandedRowCount="99999999" x:FullColumns="1" x:FullRows="1">'+ CRLF
...
cHtml+= '   <Column ss:AutoFitWidth="0" ss:Width="81" ss:Span="23"/>'+ CRLF
cHtml+= '   <Column ss:Index="36" ss:AutoFitWidth="0" ss:Width="0.75"/>'+ CRLF
cHtml+= '   <Row ss:AutoFitHeight="0" ss:Height="18">'+ CRLF
cHtml+= '    <Cell ss:MergeAcross="4" ss:StyleID="s21"><Data ss:Type="String">PROFIT & LOSS FY '+CTG->CTG_EXERC+'</Data><NamedCell ss:Name="Print_Titles"/></Cell>'+ CRLF
