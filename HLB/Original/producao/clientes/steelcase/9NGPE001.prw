...
*/                 
*----------------------*
User Function 9NGPE001()
*----------------------*
Private cPerg := "9NGPE001"
...
oWizard := APWizard():New("Relatorio", ""/*<chMsg>*/, "Payrroll Steelcase",;
										"Geração de arquivo Payrroll Steelcase",;
...
PutSx1( cPerg, "01", "Ano?"						, "Ano?"  					, "Ano?"   					, "", "C",4 ,00,00,"G",'';
			, ""	,"","","MV_PAR01","","","","2015"	,"","","","","","","","","","","","")
PutSx1( cPerg, "02", "Filial De ?  "	   		, "Filial De ?  " 	   		, "Filial De ?  " 	  		, "", "C",2 ,00,00,"G",'';
			, "XM0"	,"","","MV_PAR02","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "03", "Filial Até?"	 	  		, "Filial Até?" 	  	 	, "Filial Até ?  " 	   		, "", "C",2 ,00,00,"G",'';
			, "XM0"	,"","","MV_PAR03","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "04", "Centro de Custo De ?  "	, "Centro de Custo De ?  " 	, "Centro de Custo De ?  " 	, "", "C",9 ,00,00,"G",'';
			, "CTT"	,"","","MV_PAR04","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "05", "Centro de Custo Até?"	 	, "Centro de Custo Até?"  	, "Centro de Custo Até ?  " , "", "C",9 ,00,00,"G",'';
			, "CTT"	,"","","MV_PAR05","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "06", "Matricula De ?  "	   		, "Matricula De ?  " 	   	, "Matricula De ?  " 		, "", "C",6 ,00,00,"G",'';
			, "SRA" ,"","","MV_PAR06","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "07", "Matricula Até?"	 		, "Matricula Até?" 	  	 	, "Matricula Até ?  " 		, "", "C",6 ,00,00,"G",'';
			, "SRA" ,"","","MV_PAR07","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "08", "Situacoes a Imp. ? "	 	, "Situacoes a Imp. ? "  	, "Situacoes a Imp. ? " 	, "", "C",5 ,00,00,"G",'fSituacao';
			, "" 	,"","","MV_PAR08","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "09", "Categorias a Imp. ?" 		, "Categorias a Imp. ? "  	, "Categorias a Imp. ?" 	, "", "C",15,00,00,"G",'fCategoria';
			, ""	,"","","MV_PAR09","","","",""		,"","","","","","","","","","","","")
PutSx1( cPerg, "10", "Consolidado ?" 			, "Consolidado?"  			, "Consolidado ?"  			, "", "N",1 ,00,01,"C",'';
			, ""	,"","","MV_PAR10","Sim","","",""	,"Não","","","","","","","","","","","")
PutSx1( cPerg, "11", "Total por CC ?" 			, "Total por CC ?"  		, "Total por CC ?"   		, "", "N",1 ,00,01,"C",'';
			, ""	,"","","MV_PAR11","Sim","","",""	,"Não","","","","","","","","","","","")
PutSx1( cPerg, "12", "Exibe Provisão?" 			, "Exibe Provisão?"  		, "Exibe Provisão?"   		, "", "N",1 ,00,01,"C",'';
			, ""	,"","","MV_PAR12","Sim","","",""	,"Não","","","","","","","","","","","")
PutSx1( cPerg, "13", "Imp. Bases?" 		  		, "Imp. Bases?"  	  		, "Imp. Bases?"   			, "", "N",1 ,00,01,"C",'';
			, ""	,"","","MV_PAR13","Sim","","",""	,"Não","","","","","","","","","","","")
For i:=1 to nValPerg
	nOrdem := 13 + i
	PutSx1(cPerg,STRZERO(nOrdem,2),"Verbas","Verbas","Verbas","","C",60,00,00,"G",'', "","","","MV_PAR"+STRZERO(nOrdem,2))
Next i
...
cXML += '     <Cell ss:Index="39" ss:MergeAcross="1" ss:StyleID="s127"><Data ss:Type="Number">'+ALLTRIM(STRTRAN(Transform(aDados[13],"9999999999.99"),",","."))+'</Data></Cell>
