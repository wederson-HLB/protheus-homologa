...
±±³ Programa  ³ 0FFIN002().PRW ³ Autor³ Anderson Arrais³ Data ³ 18/09/2015 ³±±
...
While xFilial("SE1") == SE1->E1_FILIAL .AND. SE1->E1_PREFIXO == MV_PAR01 .AND. SE1->E1_NUM <= Mv_Par03
	...
	//AOA - 25/09/2015 - Retirada validação.
	If Alltrim(SM0->M0_CODIGO) $ "0F"     // NTT
		cBanco    := "341"
		cAgencia  := "0262 "
		cConta    := "075856    "
		cSubConta := "001"	  
	...
	CB_RN_NN := Ret_cBarra(aDadosBanco[1],aDadosBanco[3],aDadosBanco[4],aDadosBanco[5],cNroDoc,(E1_SALDO-_nVlrAbat),E1_VENCREA,aDadosBanco[6])
	...
	(E1_SALDO+E1_ACRESC-E1_DECRESC-_nVlrAbat)}             			//[11] Valor do Titulo liquido
...
oPrint:Say (_nLin+1080,1950,AllTrim(Transform(aDadosTit[9],"@E 999,999,999.99")),oFont10) //AOA - ADICONADO PARA SOLUCIONAR O CHAMADO 032254	  
...
oPrint:Say (_nLin+1290,1950,AllTrim(Transform(aDadosTit[10],"@E 999,999,999.99")),oFont10) //AOA - ADICONADO PARA SOLUCIONAR O CHAMADO 032254 
oPrint:Say (_nLin+1330,1910,"(=)Valor Cobrado",oFont8)
oPrint:Say (_nLin+1360,1950,AllTrim(Transform(aDadosTit[11],"@E 999,999,999.99")),oFont10) //AOA Alterado para solucionar do caso 032254
...
oPrint:Say (_nLin+2370,1950,AllTrim(Transform(aDadosTit[9],"@E 999,999,999.99")),oFont10) //AOA - ADICONADO PARA SOLUCIONAR O CHAMADO 032254 
...
oPrint:Say (_nLin+2580,1950,AllTrim(Transform(aDadosTit[10],"@E 999,999,999.99")),oFont10) //AOA Alterado para solu?o do caso 032254
oPrint:Say (_nLin+2620,1910,"(=)Valor Cobrado",oFont8)
oPrint:Say (_nLin+2650,1950,AllTrim(Transform(aDadosTit[11],"@E 999,999,999.99")),oFont10)//AOA Alterado para solucionar o caso 032254
