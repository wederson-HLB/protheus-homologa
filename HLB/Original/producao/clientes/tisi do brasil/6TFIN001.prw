...
Objetivos   : Impressao de Boleto Bancario do Banco Bank of America Merrill Lynch com Codigo de Barras,
			  Linha Digitavel e Nosso NumeroBaseado.
...
LOCAL nRec      := 0
LOCAL _nVlrAbat := 0
Local cFileName,cEmail,cSubject,cFile,IMP_PDF
...
SQL->(dbGoTop())
cFileName := "Boleto_TISI_" + AllTrim(  SQL->E1_NUM )
...
WHILE SQL->(!EOF())
	...
	dbSelectArea("SEE")
	dbSetOrder(1)
	dbSeek(xFilial("SEE")+SE1->(E1_PORTADO+E1_AGEDEP+E1_CONTA)+"004",.T.)
	...
	aDadosBanco := {"755",;			 		// [1]Numero do Banco
					...
					"1306",;		 		// [3]Agencia
					"1038501-",;     		// [4]Conta Corrente
					"1",;	         		// [5]Digito da conta corrente
...
oPrint:Say (_nLin+1010	,0936," "						,oFont10)
...
oPrint:Say (_nLin+1223	,0166,"Após o vencimento cobrar multa de R$ "+AllTrim(Transform((aDadosTit[5]*0.05),"@E 99,999.99")),oFont10)   
oPrint:Say (_nLin+1253	,0166,"Mora Diaria de R$ "+AllTrim(Transform((aDadosTit[5]*0.01/30),"@E 99,999.99")),oFont10)
oPrint:Say (_nLin+1283	,0166,"PROTESTAR APÓS 15 DIAS DE ATRASO",oFont10)
