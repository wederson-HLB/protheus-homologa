...
±±∫Programa  ≥ISFAT001     ∫ Autor ≥  Matheus       ∫ Data ≥ 08/08/2011   ∫±±
...
Private limite           := 220
Private tamanho          := "G"
Private nomeprog         := "ISFAT001" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo            := 18
...
Private CONTFL     := 01
Private m_pag      := 01
Private wnrel      := "ISFAT001" // Coloque aqui o nome do arquivo usado para impressao em disco
...
U_PUTSX1( "RELSF2ISTM", "01", "Documento De:", "Documento De:", "Documento De:", "", "C",9,00,00,"G","" , "","","","MV_PAR01")
U_PUTSX1( "RELSF2ISTM", "02", "Documento Ate:", "Documento Ate:", "Documento Ate:", "", "C",9,00,00,"G","" , "","","","MV_PAR02")
U_PUTSX1( "RELSF2ISTM", "03", "Cliente De:", "Cliente De:", "Cliente De:", "", "C",6,00,00,"G","" , "SA1","","","MV_PAR03")
U_PUTSX1( "RELSF2ISTM", "04", "Cliente Ate:", "Cliente Ate:", "Cliente Ate:", "", "C",6,00,00,"G","" , "SA1","","","MV_PAR04")
//PutSx1( "RELSF2ISTM", "05", "Fornecedor De:", "Fornecedor De:", "Fornecedor De:", "", "C",6,00,00,"G","" , "SA2","","","MV_PAR05")
//PutSx1( "RELSF2ISTM", "06", "Fornecedor Ate:", "Fornecedor Ate:", "Fornecedor Ate:", "", "C",6,00,00,"G","" , "SA2","","","MV_PAR06")
U_PUTSX1( "RELSF2ISTM", "05", "Data De:", "Data De:", "Data De:", "", "D",08,00,00,"G","U_ValSF2IS(MV_PAR05)" , "","","","MV_PAR05")
U_PUTSX1( "RELSF2ISTM", "06", "Data Ate:", "Data Ate:", "Data Ate:", "", "D",08,00,00,"G","U_ValSF2IS(MV_PAR06)" , "","","","MV_PAR06")
U_PUTSX1( "RELSF2ISTM", "07", "CFOP:", "CFOP:", "CFOP:", "", "C",50,00,00,"G","U_ValSF2CG(MV_PAR07)" , "","","","MV_PAR07",,,,,,,,,,,,,,,,,{"Coloque o CFOP separado por /","exemplo: 5102/6102/6108"})
U_PUTSX1( "RELSF2ISTM", "08", "Por Centro Custo?", "Por Centro Custo?", "Por Centro Custo?", "", "N",1,00,00,"C","" , "","","","MV_PAR08","Sim","","","","N„o") 
U_PUTSX1( "RELSF2ISTM", "09", "Gera Excel?", "Gera Excel?", "Gera Excel?", "", "N",1,00,00,"C","" , "","","","MV_PAR09","Sim","","","","N„o")

Private cString := "SF2" 
Private cPerg := "RELSF2ISTM"
...
if MV_PAR08==2
	...
	cQry1 :=" SELECT F2_SERIE,F2_DOC,F2_EMISSAO,F2_CLIENTE,B1_COD,B1_DESC,D2_QUANT,D2_CF,D2_VALBRUT,D2_VALICM,D2_VALIPI,D2_VALISS,D2_VALIMP5,D2_VALIMP6, D2_VALBRUT-(D2_VALICM+D2_VALIPI+D2_VALISS+D2_VALIMP5+D2_VALIMP6) AS 'D2_VALLIQ', A1_EST,F4_CRDPRES, SD2.R_E_C_N_O_ "+CRLF
	cQry1 +=" FROM "+RETSQLNAME("SF2")+" SF2 "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SA1")+" SA1 ON A1_COD = F2_CLIENTE AND A1_LOJA = F2_LOJA"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SD2")+" SD2 ON D2_DOC = F2_DOC AND D2_SERIE = F2_SERIE"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SB1")+" SB1 ON B1_COD = D2_COD"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SF4")+" SF4 ON F4_CODIGO = D2_TES"+CRLF
	cQry1 +=" WHERE  SF2.D_E_L_E_T_ = '' AND SA1.D_E_L_E_T_ = '' AND SD2.D_E_L_E_T_='' AND SB1.D_E_L_E_T_='' AND SF4.D_E_L_E_T_=''"+CRLF
	cQry1 +=" AND F2_DOC BETWEEN UPPER('"+MV_PAR01+"') AND UPPER('"+MV_PAR02+"')"+CRLF
	cQry1 +=" AND F2_CLIENTE BETWEEN UPPER('"+MV_PAR03+"') AND UPPER('"+MV_PAR04+"')"+CRLF
	cQry1 +=" AND F2_EMISSAO BETWEEN UPPER('"+DTOS(MV_PAR05)+"') AND UPPER('"+DTOS(MV_PAR06)+"') "+CRLF
	cQry1 +=" AND D2_CF IN ("+cQrCFOP+")"+CRLF
	cQry1 +=" GROUP BY F2_SERIE,F2_DOC,F2_EMISSAO,F2_CLIENTE,B1_COD,B1_DESC,D2_QUANT,D2_CF,D2_VALBRUT,D2_VALICM,D2_VALIPI,D2_VALISS,D2_VALIMP5,D2_VALIMP6, D2_VALBRUT-(D2_VALICM+D2_VALIPI+D2_VALISS+D2_VALIMP5+D2_VALIMP6), A1_EST,F4_CRDPRES, SD2.R_E_C_N_O_"+CRLF
//	cQry1 +=" ORDER BY F2_DOC,F2_SERIE,D2_CF
	
	cQry1 +=" UNION ALL"+CRLF
 
	cQry1 +=" SELECT F1_SERIE,F1_DOC,F1_EMISSAO,F1_FORNECE,B1_COD,B1_DESC,-D1_QUANT AS D1_QUANT,D1_CF,-((D1_TOTAL+D1_VALFRE)-D1_VALDESC) AS D1_TOTAL,-D1_VALICM AS D1_VALICM,-D1_VALIPI AS D1_VALIPI,-D1_VALISS AS D1_VALISS,-D1_VALIMP5 AS D1_VALIMP5,-D1_VALIMP6 AS D1_VALIMP6, -(((D1_TOTAL+D1_VALFRE)-D1_VALDESC)-(D1_VALICM+D1_VALIPI+D1_VALISS+D1_VALIMP5+D1_VALIMP6)) AS 'D1_VALLIQ', A1_EST,F4_CRDPRES, SD1.R_E_C_N_O_ "+CRLF
	cQry1 +=" FROM "+RETSQLNAME("SF1")+" SF1"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SA1")+" SA1 ON A1_COD = F1_FORNECE AND A1_LOJA = F1_LOJA "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SD1")+" SD1 ON D1_DOC = F1_DOC AND D1_SERIE = F1_SERIE "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SB1")+" SB1 ON B1_COD = D1_COD "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SF4")+" SF4 ON F4_CODIGO = D1_TES "+CRLF
	cQry1 +=" WHERE  SF1.D_E_L_E_T_ = '' AND SA1.D_E_L_E_T_ = '' AND SD1.D_E_L_E_T_='' AND SB1.D_E_L_E_T_='' AND SF4.D_E_L_E_T_='' "+CRLF
	cQry1 +=" AND F1_DOC BETWEEN UPPER('"+MV_PAR01+"') AND UPPER('"+MV_PAR02+"') "+CRLF
//	cQry1 +=" AND F1_FORNECE BETWEEN UPPER('"+MV_PAR05+"') AND UPPER('"+MV_PAR06+"') "+CRLF
	cQry1 +=" AND F1_FORNECE BETWEEN UPPER('"+MV_PAR03+"') AND UPPER('"+MV_PAR04+"')"+CRLF
	cQry1 +=" AND F1_EMISSAO BETWEEN UPPER('"+DTOS(MV_PAR05)+"') AND UPPER('"+DTOS(MV_PAR06)+"')"+CRLF
	cQry1 +=" AND D1_CF IN ("+cQrCFOP+") "+CRLF
	cQry1 +=" GROUP BY F1_SERIE,F1_DOC,F1_EMISSAO,F1_FORNECE,B1_COD,B1_DESC,D1_QUANT,D1_CF,((D1_TOTAL+D1_VALFRE)-D1_VALDESC),D1_VALICM,D1_VALIPI,D1_VALISS,D1_VALIMP5,D1_VALIMP6,(((D1_TOTAL+D1_VALFRE)-D1_VALDESC)-(D1_VALICM+D1_VALIPI+D1_VALISS+D1_VALIMP5+D1_VALIMP6)), A1_EST,F4_CRDPRES, SD1.R_E_C_N_O_ "+CRLF
	cQry1 +=" ORDER BY F2_EMISSAO,F2_DOC,F2_SERIE,D2_CF"

else

	cQry1 :=" SELECT D2_CCUSTO,F2_SERIE,F2_DOC,F2_EMISSAO,F2_CLIENTE,B1_COD,B1_DESC,D2_QUANT,D2_CF,D2_VALBRUT,D2_VALICM,D2_VALIPI,D2_VALISS,D2_VALIMP5,D2_VALIMP6, D2_VALBRUT-(D2_VALICM+D2_VALIPI+D2_VALISS+D2_VALIMP5+D2_VALIMP6) AS 'D2_VALLIQ',A1_EST ,F4_CRDPRES, SD2.R_E_C_N_O_"+CRLF
	cQry1 +=" FROM "+RETSQLNAME("SF2")+" SF2"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SA1")+" SA1 ON A1_COD = F2_CLIENTE AND A1_LOJA = F2_LOJA"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SD2")+" SD2 ON D2_DOC = F2_DOC AND D2_SERIE = F2_SERIE"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SB1")+" SB1 ON B1_COD = D2_COD"+CRLF
	...
	cQry1 +=" AND F2_EMISSAO BETWEEN UPPER('"+DTOS(MV_PAR05)+"') AND UPPER('"+DTOS(MV_PAR06)+"') "+CRLF
	cQry1 +=" AND D2_CF IN ("+cQrCFOP+")"+CRLF
	cQry1 +=" GROUP BY D2_CCUSTO,F2_SERIE,F2_DOC,F2_EMISSAO,F2_CLIENTE,B1_COD,B1_DESC,D2_QUANT,D2_CF,D2_VALBRUT,D2_VALICM,D2_VALIPI,D2_VALISS,D2_VALIMP5,D2_VALIMP6, D2_VALBRUT-(D2_VALICM+D2_VALIPI+D2_VALISS+D2_VALIMP5+D2_VALIMP6),A1_EST,F4_CRDPRES, SD2.R_E_C_N_O_"+CRLF
//	cQry1 +=" ORDER BY D2_CCUSTO,F2_DOC,F2_SERIE,D2_CF

	cQry1 +=" UNION ALL"+CRLF

	cQry1 +=" SELECT D1_CC,F1_SERIE,F1_DOC,F1_EMISSAO,F1_FORNECE,B1_COD,B1_DESC,-D1_QUANT AS D1_QUANT,D1_CF,-((D1_TOTAL+D1_VALFRE)-D1_VALDESC) AS D1_TOTAL,-D1_VALICM AS D1_VALICM,-D1_VALIPI AS D1_VALIPI,-D1_VALISS AS D1_VALISS,-D1_VALIMP5 AS D1_VALIMP5,-D1_VALIMP6 AS D1_VALIMP6, -(((D1_TOTAL+D1_VALFRE)-D1_VALDESC)-(D1_VALICM+D1_VALIPI+D1_VALISS+D1_VALIMP5+D1_VALIMP6)) AS 'D1_VALLIQ',A1_EST ,F4_CRDPRES, SD1.R_E_C_N_O_ "+CRLF
	cQry1 +=" FROM "+RETSQLNAME("SF1")+" SF1"+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SA1")+" SA1 ON A1_COD = F1_FORNECE AND A1_LOJA = F1_LOJA "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SD1")+" SD1 ON D1_DOC = F1_DOC AND D1_SERIE = F1_SERIE "+CRLF
	cQry1 +=" JOIN "+RETSQLNAME("SB1")+" SB1 ON B1_COD = D1_COD "+CRLF
...
//	cQry1 +=" AND F1_FORNECE BETWEEN UPPER('"+MV_PAR05+"') AND UPPER('"+MV_PAR06+"') "+CRLF
	...
	cQry1 +=" AND F1_EMISSAO BETWEEN UPPER('"+DTOS(MV_PAR05)+"') AND UPPER('"+DTOS(MV_PAR06)+"')"+CRLF
	cQry1 +=" AND D1_CF IN ("+cQrCFOP+")"+CRLF
	cQry1 +=" GROUP BY D1_CC,F1_SERIE,F1_DOC,F1_EMISSAO,F1_FORNECE,B1_COD,B1_DESC,D1_QUANT,D1_CF,((D1_TOTAL+D1_VALFRE)-D1_VALDESC),D1_VALICM,D1_VALIPI,D1_VALISS,D1_VALIMP5,D1_VALIMP6, (((D1_TOTAL+D1_VALFRE)-D1_VALDESC)-(D1_VALICM+D1_VALIPI+D1_VALISS+D1_VALIMP5+D1_VALIMP6)),A1_EST,F4_CRDPRES, SD1.R_E_C_N_O_ "+CRLF
	cQry1 +=" ORDER BY D2_CCUSTO,F2_EMISSAO,F2_DOC,F2_SERIE,D2_CF"
...
//memowrite("C:\HLB BRASIL\Querys\RELSF2IS.txt",cQry1)  
