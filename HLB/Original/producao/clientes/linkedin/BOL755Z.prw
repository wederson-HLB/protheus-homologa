...
*/ 
*-------------------------*
USER FUNCTION BOL755ZJ()
*-------------------------*
LOCAL aCampos      	:= {{"E1_NOMCLI","Cliente","@!"},{"E1_PREFIXO","Prefixo","@!"},{"E1_NUM","Titulo","@!"},;
{"E1_PARCELA","Parcela","@!"},{"E1_VALOR","Valor","@E 9,999,999.99"},{"E1_VENCREA","Vencimento"}} //JSS - Alterado de E1_VENCTO para E1_VENCREA Chamado 020937  
LOCAL	aPergs 		:= {}
...
WHILE SQL->(!EOF())
	...
	dbSelectArea("SEE")
	dbSetOrder(1)
	dbSeek(xFilial("SEE")+SE1->(E1_PORTADO+E1_AGEDEP+E1_CONTA)+"003",.T.)//POsiciona na subconta 003, devido a duplicidade de cadastro.
...
oPrint:Say (_nLin-38	,1550,"Recibo do Sacador",oFont10)
...
oPrint:Say (_nLin+143	,0106,"Sacador/Avalista"			,oFont8)
...
oPrint:Say (_nLin+283	,0106,"Nome do Sacador"		   		,oFont8)
...
oPrint:Say (_nLin+720	,0116,"APOS O VENCIMENTO ACESSE WWW.BAML.BR/BOLETOS",oFont10)
...
oPrint:Say (_nLin+990	,0886,"1.00"					,oFont10)
...
oPrint:Say (_nLin+1483	,0106,"Sacador"					,oFont8)
...
oPrint:Say (_nLin+1613	,0106,"Sacador/Avalista"		,oFont8)                                                           
