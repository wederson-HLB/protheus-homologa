...
Parametros  : Nenhum
Retorno     : Nenhum   
Objetivos   : Emissao da Pre-Nota  
Autor     	: Tiago Luiz Mendonça 
Data     	: 
Obs         : Adaptação do programa padrão MATR730
TDN         : 
...
#IFDEF TOP
	If TcSrvType() <> "AS/400"
		...
		SC6.C6_QTDEMP,SC6.C6_QTDLIB,SC6.C6_QTDENT,SC6.C6_NFORI,SC6.C6_SERIORI,SC6.C6_ITEMORI,SC6.C6_BLQ
		%Exp:cQryAd%
...
#IFDEF TOP
	If TcSrvType() <> "AS/400"
		...
		cQuery += "SC6.C6_QTDEMP,SC6.C6_QTDLIB,SC6.C6_QTDENT,SC6.C6_NFORI,SC6.C6_SERIORI,SC6.C6_ITEMORI,SC6.C6_BLQ "
		cQuery += "FROM "
...
If Alltrim(aItemPed[nItem][20]) == 'R' 
	@li,155   psay 00.00 Picture PesqPictQt("C6_QTDLIB") 
Else
