...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação dos campos e tabelas para o projeto descentralização Orange
Autor       : Matheus Massarotto
Data/Hora   : 18/02/2015    16:14
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
*---------------------*
User Function USX3050()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
                                           
Private cMessage
Private aArqUpd	 := {"ACY","ZX3","ZX4"}
Private aREOPEN	 := {}
Private oMainWnd
...
AADD(aSix,{'ZX3','1','ZX3_FILIAL+ZX3_CGC','CNPJ','CNPJ','CNPJ','U','','','S'})

AADD(aSix,{'ZX4','1','ZX4_FILIAL+ZX4_DATA','Data+Hora','Data+Hora','Data+Hora','U','','','S'})
...
AADD(aSX2,{'ZX3','\SYSTEM\','ZX3'+alltrim(SM0->M0_CODIGO)+'0','De Para Filial e Serie','De Para Filial e Serie','De Para Filial e Serie','','C','C','C','','','','S','','','',''})

AADD(aSX2,{'ZX4','\SYSTEM\','ZX4'+alltrim(SM0->M0_CODIGO)+'0','Log inclusao pedidos','Log inclusao pedidos','Sales Order Log','','C','C','C','','','','S','','','',''})
...
AADD(aSX3,{"ACY","06","ACY_P_CCLI","C","6","","Cliente","Cliente","Customer","Cliente","Cliente","Customer","","","€€€€€€€€€€€€€€ ","","SA1","","þÀ","","","U","N","A","R","" ,"IIF(!empty(M->ACY_P_CCLI),ExistCpo('SA1', M->ACY_P_CCLI, 1),.T. )","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","07","ACY_P_LOJA","C","2"  ,"","Loja","Loja","Unit","Loja","Loja","Unit","","","€€€€€€€€€€€€€€ ","","","","þÀ","","","U","N","A","R","" ,"IIF(!empty(M->ACY_P_CCLI) ,ExistCpo('SA1', M->ACY_P_CCLI+M->ACY_P_LOJA, 1),.T. )","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","08","ACY_P_NCLI","C","40" ,"","Nome Cliente","Nome Cliente","customer nam","Nome Cliente","Nome Cliente","customer name","@!","","€€€€€€€€€€€€€€ ","IF(!INCLUI,(POSICIONE('SA1',1,XFILIAL('SA1')+ACY->ACY_P_CCLI+ACY->ACY_P_LOJA,'A1_NOME')),'')","","","þÀ","","","U","N","V","V","","","","","","","","POSICIONE('SA1',1,XFILIAL('SA1')+ACY->ACY_P_CCLI+ACY->ACY_P_LOJA,'A1_NOME')","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","09","ACY_P_EMAI","C","100","","Email","Email","Email","Email","Email","Email","@!","","€€€€€€€€€€€€€€€","","","","þÀ","","","U","N","A","R","","","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","10","ACY_P_COND","C","3"  ,"","Cond. Pagto","Cond. Pagto","Payment Term","Condicao de Pagamento","Condicao de Pagamento","Payment Term","@!","","€€€€€€€€€€€€€€ ","","SE4","","þÀ","","","U","N","A","R","","IIF(!empty(M->ACY_P_COND),ExistCpo('SE4', M->ACY_P_COND, 1),.T. )","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","12","ACY_P_ENVI","L","1"  ,"","Envia Email","Envia Email","Send Email","Envia Email","Envia Email","Send Email","","","€€€€€€€€€€€€€€€","","","","þÀ","","","U","N","A","R","","","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","13","ACY_P_ATIV","L","1"  ,"","Ativo","Ativo","Active","Ativo","Ativo","Active","","","€€€€€€€€€€€€€€ ","","","","þÀ","","","U","N","A","R","","","","","","","","","","","","","","","N","N","",""})
AADD(aSX3,{"ACY","11","ACY_P_NAT" ,"C","10" ,"","Natureza","Modalidad","Class","Codigo da Nat Financeira","Cod de la Mod Financiera","Financ.Class Code","","","€€€€€€€€€€€€€€ ","","SED","","þÀ","","","U","N","A","R","","IIF(!empty(M->ACY_P_NAT),ExistCpo('SED', M->ACY_P_NAT, 1),.T. )","","","","","","","","","","","","","N","N","",""})


AADD(aSX3,{'ZX3','01','ZX3_FILIAL'	,'C','2' ,'','Filial','Filial','Filial do Si','Filial','Filial','Filial','','','€€€€€€€€€€€€€€€','','','','™€','','','U','N','','','','','','','','','','','033','1','','','','','','','',''})
AADD(aSX3,{'ZX3','02','ZX3_CGC'		,'C','14','','CNPJ','CNPJ','CNPJ','CNPJ Empresa','CNPJ Empresa','CNPJ Business','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX3','03','ZX3_BRCOD'	,'C','3' ,'','Cod Local','Cod Local','Location Cod','Codigo Local','Codigo Local','Location Code','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX3','04','ZX3_INISER'	,'C','1' ,'','Inicio Serie','Inicio Serie','Home Series','Inicio Serie','Inicio Serie','Home Series','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX3','05','ZX3_EMP'		,'C','2' ,'','Cod Empresa','Cod Empresa','Company code','Codigo Empresa','Codigo Empresa','Company Code','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX3','06','ZX3_FIL'		,'C','2' ,'','Cod Filial','Cod Filial','Branch Code','Codigo Filial','Codigo Filial','Branch Code','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})


AADD(aSX3,{'ZX4','01','ZX4_FILIAL'	,'C','2' ,'','Filial','Filial','Filial do Si','Filial','Filial','Filial','','','€€€€€€€€€€€€€€€','','','','™€','','','U','N','','','','','','','','','','','033','1','','','','','','','',''})
AADD(aSX3,{'ZX4','02','ZX4_DATA'	,'C','8','','Data','Data','Date','Data','Data','Date','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX4','03','ZX4_HORA'	,'C','8','','Hora','Hora','Time','Hora','Hora','Time','@!','','€€€€€€€€€€€€€€ ','','','','þA','','S','U','N','A','R','€','','','','','','','','','1','','','','','N','N','',''})
AADD(aSX3,{'ZX4','04','ZX4_STATUS'	,'C','15','','Status','Status','Status','Status','Status','Status','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','05','ZX4_MOTIVO'	,'C','150','','Motivo','Motivo','Reason','Motivo','Motivo','Reason','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','06','ZX4_PEDIDO'	,'C','15','','Pedido','Pedido','Sales order','Pedido','Pedido','Sales order','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','07','ZX4_NCONTR'	,'C','15','','Num Controle','Num Controle','Control Num','Numero Controle','Numero Controle','Control Number','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','08','ZX4_TIPO'	,'C','15','','Tipo','Tipo','Type','Tipo','Tipo','Type','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','09','ZX4_ARQ'		,'C','150','','Arquivo','Arquivo','File','Arquivo','Arquivo','File','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','10','ZX4_FILINC'	,'C','2','','Filial Inclu','Filial Inclu','Branch Inclu','Filial Inclusao','Filial Inclusao','Branch Inclusion','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})
AADD(aSX3,{'ZX4','11','ZX4_USER'	,'C','20','','Usuario','Usuario','User','Usuario','Usuario','User','@!','','€€€€€€€€€€€€€€ ','','','','þA','','','U','N','A','R','','','','','','','','','','','','','','','N','N','',''})

****************************************************************************************************************************************** 
//{SX7} - Gatilhos
//AADD(aSX7,{X7_CAMPO,X7_SEQUENC,X7_REGRA,X7_CDOMIN,X7_TIPO,X7_SEEK,X7_ALIAS,X7_ORDEM,X7_CHAVE,X7_CONDIC,X7_PROPRI})

//AADD(aSX7,{"A1_P_GECTA","001","U_GTSXB002(M->A1_P_GECTA)","A1_P_NGCTA","P","N","","","","","U"})
...
AADD(aSX6,{"","MV_P_00043","D","Data inicial permitida para grupamento de titulos","","","de grupos de clientes","","","","","","01/01/2013","01/01/2013","01/01/2013","U","","","","","",""})
...
*------------------------------*
Static Function CargaZX3(cTexto)
*------------------------------*
Local lInc
Local aCarga:= {;
{"BSB","66624776002304","L","LW","23"},;
{"VIX","66624776001839","J","LW","18"},;
{"GYN","66624776001324","I","LW","13"},;
{"REC","66624776002800","O","LW","28"},;
{"POA","66624776000786","D","LW","07"},;
{"BLU","66624776000867","E","LW","08"},;
{"SSA","66624776003106","P","LW","31"},;
{"FOR","66624776002568","M","LW","25"},;
{"BHO","66624776001910","K","LW","19"},;
{"CUR","66624776000514","C","LW","05"},;
{"RJT","66624776001243","H","LW","12"},;
{"SPB","66624776000190","B","LW","01"};
}
//{"MAO","66624776002991","Q","LW","29"},;

for i:=1 to len(aCarga)

	DbSelectArea("ZX3")
	ZX3->(DbSetOrder(1))
	if ZX3->(DbSeek(xFilial("ZX3")+aCarga[i][2]))
		lInc:=.F.
	else
		lInc:=.T.
	endif
	RecLock("ZX3",lInc)
		ZX3->ZX3_CGC	:= aCarga[i][2]
		ZX3->ZX3_BRCOD	:= aCarga[i][1]
		ZX3->ZX3_INISER	:= aCarga[i][3]
		ZX3->ZX3_EMP	:= aCarga[i][4]
		ZX3->ZX3_FIL	:= aCarga[i][5]
	ZX3->(MsUnlock())
    
	if lInc
		cTexto += "Incluido no ZX3 - o codigo:"+aCarga[i][1]+NL
    else
	    cTexto += "Alterado no ZX3 - o codigo:"+aCarga[i][1]+NL
    endif
