...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Nota Fiscal Packing - Entrada e Saída 
Autor     	: Vitor Bedin
Data     	: 06/10/09   
Obs         : Fonte Draft, 12
TDN         : 
...
If cEmpAnt $ "PA"
   ...
   Endif
Else
    MsgInfo("Especifico Packing ","A T E N C A O")  
Endif   
...
tamanho  :='G'
limite   :=220
titulo   :="Nota Fiscal - Entrada / Saida - Packing"
cDesc1   :=' '
cDesc2   :=''
...
If _cTpMov == 1
   fGerSf1()
   RptStatus({|| fImpSF1()},"Nota de Entrada - Packing")
Else
   fGerSf2()
   RptStatus({|| fImpSF2()},"Nota de Saida - Packing")
Endif   
