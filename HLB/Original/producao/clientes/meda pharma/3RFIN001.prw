...
LOCAL aBitmap   := {	MV_PAR19,;		// Banner Publicitario
						"LGRLBRA.bmp"}		// Logo da Empresa

LOCAL aDadosEmp := {SUBSTR (AllTrim(SM0->M0_NOMECOM),1,35),;																 //[1]Nome da Empresa
...
oPrint:Say (_nLin+0940,1050,"DM", oFont10) //aDadosTit[8],oFont10) //Tipo do Titulo
...
oPrint:Say (_nLin+2230,1050,"DM",oFont10)                   //aDadosTit[8],oFont10)					//Tipo do Titulo
