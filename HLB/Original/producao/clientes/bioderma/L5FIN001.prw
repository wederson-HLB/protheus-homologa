...
±±³ Programa  ³ L5FIN001().PRW ³ Autor ³               ³ Data ³ 21/09/2011 ³±±
...
TDN         : 
Revisão     : João Silva 
Data/Hora   : 21/08/2014
Módulo      : Financeiro.
*/    

*--------------------------*
  USER FUNCTION L5FIN001()     
*--------------------------*
...
While xFilial("SE1") == SE1->E1_FILIAL .AND. SE1->E1_PREFIXO == MV_PAR01 .AND. SE1->E1_NUM <= Mv_Par03
	...
	If Empty(cBanco) .Or. Empty(cAgencia) .Or. Empty(cConta)
		...
		If Alltrim(SM0->M0_CODIGO) $ "L5/99"     // SHOPZILLA
			cBanco    := "399"
			cAgencia  := "0223 "
			cConta    := "0269377   "
			cSubConta := "001"	  
...
oPrint:Say (_nLin+0750,0100,"PAGAR PREFERENCIALMENTE EM AGÊNCIA DO HSBC",oFont8)
...
oPrint:Say (_nLin+2040,0100,"PAGAR PREFERENCIALMENTE EM AGÊNCIA DO HSBC",oFont8)
