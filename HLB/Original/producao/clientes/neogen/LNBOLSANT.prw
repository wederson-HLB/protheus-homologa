...
oPrint:Say (_nLin+1300,0100,aBolText[4],oFont10)
oPrint:Say (_nLin+1050,1910,"(-)Desconto/Abatimento",oFont8)
oPrint:Say (_nLin+1080,1950,AllTrim(Transform(aDadosTit[9],"@E 999,999,999.99")),oFont10) //AOA 27/11/2015 - ADICONADO PARA SOLUCIONAR O CHAMADO 030817  
...
oPrint:Say (_nLin+1290,1950,AllTrim(Transform(aDadosTit[10],"@E 999,999,999.99")),oFont10) //AOA 27/11/2015 - ADICONADO PARA SOLUCIONAR O CHAMADO 030817  
...
If Alltrim(aDatSacado[8]) == 'F'
	oPrint:Say (_nLin+1589,0400,"C.P.F.: "+TRANSFORM(aDatSacado[7],"@R 999.999.999-99"),oFont10) // CPF
Else
...
oPrint:Say (_nLin+2590,0100,aBolText[4],oFont10)
oPrint:Say (_nLin+2340,1910,"(-)Desconto/Abatimento",oFont8)
oPrint:Say (_nLin+2370,1950,AllTrim(Transform(aDadosTit[9],"@E 999,999,999.99")),oFont10) //AOA 27/11/2015 - ADICONADO PARA SOLUCIONAR O CHAMADO 030817  
...
oPrint:Say (_nLin+2580,1950,AllTrim(Transform(aDadosTit[10],"@E 999,999,999.99")),oFont10) //AOA 27/11/2015 - ADICONADO PARA SOLUCIONAR O CHAMADO 030817  
...
//RRP - 30/10/2014 - CNPJ ou CPF. Chamado 022287.
If Alltrim(aDatSacado[8]) == 'F'
	oPrint:Say (_nLin+2879,0400,"C.P.F.: "+TRANSFORM(aDatSacado[7],"@R 999.999.999-99"),oFont10) // CPF
Else
