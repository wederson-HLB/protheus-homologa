...
wdir := 'V:\Team\EBS Shared Prod\receivables\Brasil'//RRP - 15/10/2012 - Altera��o do diret�rio padr�o conforme chamado 007670
...
if lPedido 
   If ! file(wdir)//file(wdir+"\ORDERS\ORDERS.TXT")
        ...
        MsgInfo("Arquivo não encontrado: "+Alltrim(wdir)," A t e n ç ã o")
        Close(oDlg)
        Return nil
   endif     
   lBOM := .T.   
...
//-----------------------------------------------------------------//
//--Cria Parametros utilizados pela rotina se n�o existir          //
//-----------------------------------------------------------------//
//--29/08/05 --> Carrega as TES conforme condi��es infomadas por   //
//--pela Roseli/Rosana.                                                   //
//-----------------------------------------------------------------//
...
//--------------------------------------------------------//
//--Ponto de entrada na exclus�o do pedido                //
//--------------------------------------------------------//
//--Wederson L. Santana                                   //
//--------------------------------------------------------//
