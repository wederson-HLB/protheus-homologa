...
If !cEmpAnt $ "AZ/99"
	MsgInfo("Especifico Ordem Suprema, verifique a empresa!","A T E N C A O ")
	return
Endif
...
If Alltrim(SM0->M0_CODIGO) $ "AZ/99" 
	cPortGrv    := "033"
	cAgeGrv     := "3853 "
	cContaGrv   := "13000714-7"
	cCodEmp		:= "3933580"
EndIf                                    
...
WHILE SQL->(!EOF())
	...
	CB_RN_NN := Ret_cBarra(Subs(aDadosBanco[1],1,3)+"9",aDadosBanco[3],aDadosBanco[4],aDadosBanco[5],substr(cNroDoc,1,len(cNroDoc)-1),(E1_VALOR-_nVlrAbat),E1_VENCTO)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
STATIC FUNCTION Modulo11(cData,lBar)
LOCAL L, D, P := 0
DEFAULT lBar:=.F.
