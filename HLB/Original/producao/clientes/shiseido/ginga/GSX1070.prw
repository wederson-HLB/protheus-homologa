...
/*/
----------+-------------------------------------------------------------
Programa  |³GSX1070   | Autor | FRANCISCO F.S. NETO    | Data | 17.09.03
----------|-------------------------------------------------------------
Descri‡…o | Set Items Header                                                
----------|-------------------------------------------------------------
Uso       |Especifico para o Cliente SHISEIDO DO BRASIL
          |Geracao do texto: GS780SCM07_AAAAMMDD.XML 
...
wdir := 'C:\GINGA\GS780scm07_' + "20" + SUBSTR(DTOC(dDATABASE),7,2) + SUBSTR(DTOC(dDATABASE),4,2) + SUBSTR(DTOC(dDATABASE),1,2) + '.XML'
...
//--------------------------------------------------------------
	...
	@ 0,0 TO 120,400 DIALOG oDlg2 TITLE  "  Geracao do texto GSXML1070 - Set Items Header "  
	@ 001,005 TO 090,200 
