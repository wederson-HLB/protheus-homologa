...
*----------------------------------------*
USER FUNCTION S2FIN001(lSelAuto,lPreview)
*----------------------------------------*
Local aArea			:= GetArea()
Local aPergs 		:= {}
Local lExec         := .T.
...
Local cDirBol	:= "\FTP\" + cEmpAnt + "\S2FIN001\"    
Local cNroDoc	:= ""
...
While !EOF() .AND. xFilial("SE1") == SE1->E1_FILIAL .AND. SE1->E1_PREFIXO == MV_PAR01 .AND. SE1->E1_NUM <= Mv_Par03
	...
	If !Empty(SE1->E1_PORTADO) .AND. SE1->E1_PORTADO <> "341" //Código do itau para o JP MORGAN boleto 
		SE1->(dbSkip())
		Loop
	Endif 
	If ( SE1->E1_SALDO == 0 )
...
oPrint:Line(0140,0560,0040,0560)
oPrint:Line(0140,0800,0040,0800)
...
oPrint:Line(0140,0100,0140,2300)
oPrint:Say (0150+_nLin2,0100,"Beneficiário",oFont8)
oPrint:Say (0200+_nLin2,0100,Substr(aDadosEmp[1],1,53)	,oFont10)				// [1] Nome + CNPJ
...
oPrint:Line(0240,0100,0240,1900)
oPrint:Line(0340,0100,0340,1900)
oPrint:Line(0440,1050,0440,1900) //---
oPrint:Line(0540,0100,0540,2300)
oPrint:Line(0540,1050,0140,1050)
oPrint:Line(0540,1400,0340,1400)
oPrint:Line(0340,1500,0140,1500) //--
oPrint:Line(0540,1900,0140,1900)
...
NEXT i
oPrint:Line(_nLin+0700,0100,_nLin+0700,2300)
oPrint:Line(_nLin+0700,0560,_nLin+0600,0560)
oPrint:Line(_nLin+0700,0800,_nLin+0600,0800)
...
oPrint:Line(_nLin+0800,0100,_nLin+0800,2300)
oPrint:Line(_nLin+0900,0100,_nLin+0900,2300)
oPrint:Line(_nLin+0970,0100,_nLin+0970,2300)
oPrint:Line(_nLin+1040,0100,_nLin+1040,2300)
oPrint:Line(_nLin+0900,0500,_nLin+1040,0500)
oPrint:Line(_nLin+0970,0750,_nLin+1040,0750)
oPrint:Line(_nLin+0900,1000,_nLin+1040,1000)
oPrint:Line(_nLin+0900,1350,_nLin+0970,1350)
oPrint:Line(_nLin+0900,1550,_nLin+1040,1550)
...
oPrint:Say (_nLin+_nLin2+1050,0100,"Instruções (TODAS AS INFORMAÇÕES DESTE BLOQUETO SÃO DE EXCLUSIVA RESPONSABILIDADE DO BENEFICIÁRIO)",oFont8)
...
oPrint:Line(_nLin+0700,1900,_nLin+1390,1900)
oPrint:Line(_nLin+1110,1900,_nLin+1110,2300)
oPrint:Line(_nLin+1180,1900,_nLin+1180,2300)
oPrint:Line(_nLin+1250,1900,_nLin+1250,2300)
oPrint:Line(_nLin+1320,1900,_nLin+1320,2300)
oPrint:Line(_nLin+1390,0100,_nLin+1390,2300)
oPrint:Line(_nLin+1630,0100,_nLin+1630,2300)
...
oPrint:Line(_nLin+1990,0100,_nLin+1990,2300)
oPrint:Line(_nLin+1990,0560,_nLin+1890,0560)
oPrint:Line(_nLin+1990,0800,_nLin+1890,0800)
...
oPrint:Line(_nLin+2090,0100,_nLin+2090,2300)
oPrint:Line(_nLin+2190,0100,_nLin+2190,2300)
oPrint:Line(_nLin+2260,0100,_nLin+2260,2300)
oPrint:Line(_nLin+2330,0100,_nLin+2330,2300)
oPrint:Line(_nLin+2190,0500,_nLin+2330,0500)
oPrint:Line(_nLin+2260,0750,_nLin+2330,0750)
oPrint:Line(_nLin+2190,1000,_nLin+2330,1000)
oPrint:Line(_nLin+2190,1350,_nLin+2260,1350)
oPrint:Line(_nLin+2190,1550,_nLin+2330,1550)
...
oPrint:Say (_nLin+_nLin2+2340,0100,"Instruções (TODAS AS INFORMAÇÕES DESTE BLOQUETO SÃO DE EXCLUSIVA RESPONSABILIDADE DO BENEFICIÁRIO)",oFont8)
...
oPrint:Line(_nLin+1990,1900,_nLin+2680,1900)
oPrint:Line(_nLin+2400,1900,_nLin+2400,2300)
oPrint:Line(_nLin+2470,1900,_nLin+2470,2300)
oPrint:Line(_nLin+2540,1900,_nLin+2540,2300)
oPrint:Line(_nLin+2610,1900,_nLin+2610,2300)
oPrint:Line(_nLin+2680,0100,_nLin+2680,2300)
oPrint:Line(_nLin+2920,0100,_nLin+2920,2300)
...
oPrint:FWMSBAR("INT25" /*cTypeBar*/,64/*nRow*/ ,2/*nCol*/, CB_RN_NN[1]/*cCode*/,oPrint/*oPrint*/,.F./*lCheck*/,/*Color*/,.T./*lHorz*/,0.02/*nWidth*/,1.3/*0.8*//*nHeigth*/,.F./*lBanner*/, cFont/*cFont*/,NIL/*cMode*/,.F./*lPrint*/,1/*nPFWidth*/,1/*nPFHeigth*/,.F./*lCmtr2Pix*/)
