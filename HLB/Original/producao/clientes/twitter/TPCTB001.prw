...
cQryB+=" CT2.CT2_HIST,CT2.CT2_DATA,CT2.CT2_LOTE,CT2.CT2_SBLOTE,CT2.CT2_DOC,CT2.CT2_LINHA,CT2.CT2_TPSALD,CT2.CT2_EMPORI,CT2.CT2_FILORI,CT2.CT2_MOEDLC"
...
If nRecCount > 0
	...
	While SQL->(!EOF())
		...
		SQL->CT1_DESC01,;
		"720",;
		IIF(EMPTY(SQL->CENT_CUST),SQL->CENT_CUSTD,SQL->CENT_CUST),;
		SQL->CT1_P_CONT,;
		"0000",;
