...
*-------------------------*
	...
	Begin Transaction
		...
		If nTpEtiq == 1
			For _I := 1 To nQtd
				U_LGGEN001(cPorta, "",AllTrim(Str(SB1->B1_CONV)),SB1->B1_UM,"",DToC(ZX1->ZX1_DTVAL),cProd,cLote,SB1->B1_DESC,ZX1->ZX1_CODETI)
			Next _I
		Else
			U_LGGEN002(cPorta, nQtd,DToC(ZX1->ZX1_DTVAL),cLote,SB1->B1_DESC,ZX1->ZX1_CODETI)
		EndIf
	End Transaction
