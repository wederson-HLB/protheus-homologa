...
Static Function Imprime(cPedido,cNF,nVolume,cCliente,cCidade,cTransp,nVolde,nVolate)
	*--------------------------------------------------------------------------------------*
	...
	Private limite       := 80
	Private Tamanho      := "P"
	Private nomeprog     := "LGFAT002" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private CONTFL       := 01
	Private m_pag        := 01
	Private wnrel        := "LGFAT002" // Coloque aqui o nome do arquivo usado para impressao em disco
	Private cString      := ""
