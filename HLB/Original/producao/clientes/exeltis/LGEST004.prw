...
Private limite      := 132
Private tamanho     := "M"
Private nomeprog    := "LGEST004"
Private nTipo       := 15
Private aReturn     := { "Zebrado", 1, "Administracao", 1, 2, 1, "", 1}
Private nLastKey    := 0
Private cPerg       := "LGEST004"
Private cbtxt       := Space(10)
Private cbcont      := 00
Private CONTFL      := 01
Private m_pag       := 01
Private wnrel       := "LGEST004"
Private cString 	:= "SC9"
...
/*
Funcao      : RunReport
Objetivos   : Gera relatorio com base no select
Autor       : Anderson Arrais
Data/Hora   : 09/11/2017     
*/
*---------------------------------------------------*
...
_cQry += " , C6_ENTREG ENTREGA, C5_EMISSAO EMISSAO, B1_DESC PRODUTO , B1_UM UM1, B1_SEGUM UM2, C9_QTDLIB QUANT1, C9_QTDLIB2 QUANT2, C9_LOCAL LOCAL"
//_cQry += " , DC_LOCAL LOCAL, DC_LOCALIZ ENDERECO, DC_QUANT QUANT1, "
...
_cQry += " ) B8 ON B8_FILIAL = C9_FILIAL AND B8_LOCAL = C9_LOCAL AND B8_PRODUTO = C9_PRODUTO AND B8_LOTECTL = C9_LOTECTL"
...
_cQry += " ORDER BY C9_PEDIDO, B1_COD"
...
While !QRY->(EOF())
	...
	If nLin > 70 .OR. _cPedAnt <> QRY->PEDIDO
		...
		Cabec2       := "Arm Qtde.Fra.     Qtde.Emb.  Lote Fornecedor    Lote Interno Produto"
		Cabec(Titulo,Cabec1,Cabec2,NomeProg,Tamanho,nTipo)
		nLin := 9
	Endif
	
	@nLin,000 PSAY QRY->LOCAL
	@nLin,005 PSAY QRY->QUANT1 Picture "@E 9999999"
	@nLin,013 PSAY QRY->UM1
	If QRY->QUANT2 > 0
		@nLin,018 PSAY QRY->QUANT2 Picture "@E 9999999"
		@nLin,026 PSAY QRY->UM2
	EndIf
	@nLin,030 PSAY QRY->LOTEFOR
	@nLin,049 PSAY QRY->LOTEINT
	@nLin,062 PSAY QRY->PRODUTO
...
Arm Qtde.Fra.     Qtde.Emb.  Lote Fornecedor    Lote Interno Produto
XX  9999999 XX   9999999 XX  XXXXXXXXXXXXXXXXXX XXXXXXXXXX   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XX  9999999 XX   9999999 XX  XXXXXXXXXXXXXXXXXX XXXXXXXXXX   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XX  9999999 XX   9999999 XX  XXXXXXXXXXXXXXXXXX XXXXXXXXXX   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XX  9999999 XX   9999999 XX  XXXXXXXXXXXXXXXXXX XXXXXXXXXX   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
