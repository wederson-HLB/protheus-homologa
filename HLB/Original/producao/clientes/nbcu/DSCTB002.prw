...
*/    
*-------------------------*
 User Function DSCTB002() 
*-------------------------*
Local lOk 			:= .F.
Local cPerg 		:= "DSCTB002"
...
If lAjuste
	...
	U_PUTSX1(cPerg,"05","Arquivo?","Arquivo ?","Arquivo ?","mv_ch5","C",60,0,0,"G","","","","S","mv_par05","","","","D:\DSCTB002.txt","","","","","","","","","","","","",aHlpPor,aHlpEng,aHlpSpa)
