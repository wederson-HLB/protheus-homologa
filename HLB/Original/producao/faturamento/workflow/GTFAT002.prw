...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : WorkFlow para verificação dos certificados digitais de todas as empresas.
Chamado     : 002678
...
//Private cPara    := 'kelly.bevilaqua@hlb.com.br, fernanda.bernardes@hlb.com.br, monalisa.martins@hlb.com.br, patricia.lima@hlb.com.br, priscila.santos@hlb.com.br, vilma.oliveira@hlb.com.br, jefferson.bernardino@hlb.com.br, juliane.balbo@hlb.com.br, sandra.barbosa@hlb.com.br, leandro.viana@hlb.com.br, erica.luz@hlb.com.br, josuel.silva@hlb.com.br' JSS- 30/11/2015 - Alterado para solu~ção do caso 030808.
//Private cPara    := 'kelly.bevilaqua@hlb.com.br, fernanda.bernardes@hlb.com.br, monalisa.martins@hlb.com.br,priscila.santos@hlb.com.br, vilma.oliveira@hlb.com.br, jefferson.bernardino@hlb.com.br, juliane.balbo@hlb.com.br, erica.luz@hlb.com.br, felipe.imola@hlb.com.br, paulo.souza@hlb.com.br, willian.galindo@hlb.com.br, tatiane.miranda@hlb.com.br' 
Private cPara    := 'kelly.bevilaqua@hlb.com.br, fernanda.bernardes@hlb.com.br, monalisa.martins@hlb.com.br,priscila.santos@hlb.com.br, vilma.oliveira@hlb.com.br, jefferson.bernardino@hlb.com.br, juliane.balbo@hlb.com.br, erica.luz@hlb.com.br, paulo.souza@hlb.com.br, willian.galindo@hlb.com.br, tatiane.miranda@hlb.com.br, tatiane.tandu@hlb.com.br, luis.costa@hlb.com.br' //RSB - 30/01/2017 - Incluido os e-mails (tatiane.tandu@hlb.com.br, luis.costa@hlb.com.br) 035504
Private cCc      := padr('log.sistemas@hlb.com.br',200)
...
If lRetorno
	...
	oWS:_URL := AllTrim(cURL)+"/SPEDCFGNFe.apw"
	oWs:CfgTSSVersao()//Busca a versão do TSS
	If oWs:CFGStatusCertificate()
		If Len(oWs:oWSCFGSTATUSCERTIFICATERESULT:OWSDIGITALCERTIFICATE) > 0
			For nX := 1 To Len(oWs:oWSCFGSTATUSCERTIFICATERESULT:OWSDIGITALCERTIFICATE)
				If 	oWs:oWSCFGSTATUSCERTIFICATERESULT:OWSDIGITALCERTIFICATE[nx]:DVALIDTO-45 <= Date() .and.;
					...
					aAdd(aCert, {SM0->M0_NOME+"\"+SM0->M0_CODIGO,;                                               //Empresa/Cod
					             GetEnvServer() +" - TSS: "+ oWs:cCfgTSSVersaoResult,;					          //Ambiente
