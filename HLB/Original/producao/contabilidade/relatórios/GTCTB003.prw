...
If CT2->(FieldPos("CT2_USERGI")) == 0 .OR. CT2->(FieldPos("CT2_USERGA")) == 0
	MsgInfo('Relatório não pode ser gerado. Campo de Log inexistente!','HLB BRASIL')
	Return
EndIf
...
U_PUTSX1(  cPerg ,'01' , 'Data Inicial' ,'Data Inicial'/*cPerSpa*/,'Data Inicial'/*cPerEng*/,'mv_ch1','D' , 8 ,0 ,0/*nPresel*/,'G'/*cGSC*/,/*cValid*/,/*cF3*/, /*cGrpSxg*/,/*cPyme*/,'MV_PAR01'/*cVar01*/,/*cDef01*/,/*cDefSpa1*/,/*cDefEng1*/,/*cCnt01*/,	/*cDef02*/,/*cDefSpa2*/,/*cDefEng2*/,/*cDef03*/,/*cDefSpa3*/,/*cDefEng3*/,	/*cDef04*/,/*cDefSpa4*/,/*cDefEng4*/,/*	cDef05*/,/*cDefSpa5*/,/*cDefEng5*/,/*aHelpPor*/,/*aHelpEng*/,/*aHelpSpa*/,/*cHelp*/ )
U_PUTSX1(  cPerg ,'02' , 'Data Final' ,'Data Final'/*cPerSpa*/,'Data Final'/*cPerEng*/,'mv_ch2','D' , 8 ,0 ,0/*nPresel*/,'G'/*cGSC*/,/*cValid*/,/*cF3*/, /*cGrpSxg*/,/*cPyme*/,'MV_PAR02'/*cVar01*/,/*cDef01*/,/*cDefSpa1*/,/*cDefEng1*/,/*cCnt01*/,	/*cDef02*/,/*cDefSpa2*/,/*cDefEng2*/,/*cDef03*/,/*cDefSpa3*/,/*cDefEng3*/,	/*cDef04*/,/*cDefSpa4*/,/*cDefEng4*/,/*	cDef05*/,/*cDefSpa5*/,/*cDefEng5*/,/*aHelpPor*/,/*aHelpEng*/,/*aHelpSpa*/,/*cHelp*/ )   
	
U_PUTHELP("P." + Alltrim( cPerg ) + "01.",{ "Data Inicial do Lancamento Contabil." } ,{},{},.T.)
U_PUTHELP("P." + Alltrim( cPerg ) + "02.",{ "Data Final do Lancamento Contabil." } ,{},{},.T.)
