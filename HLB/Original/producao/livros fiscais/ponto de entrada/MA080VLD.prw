...
�������������������������������������������������������������������������͹��
���Desc.     � Ponto de entrada na grava��o da TES                        ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                        ���
�������������������������������������������������������������������������ͼ��
...
//CAS - 21/02/2017 chamado 039087 - Removido o e-mail kareane.nascimento@hlb.com.br. Inclu��o os e-mails priscila.santos/monalisa.martins/mariana.rodrigues
...
//RRP - 06/04/2018 - Valida��o se est�Eno ambiente produ��o ou homologa��o
aArea := GetArea()  
nConP1200 := TcLink( "MSSQL7/P12_00","172.16.16.152",7891 )  //CAS - 10/02/2020 Alterado dados da conexão evido a Atual.Release e servidor (MSSQL7/P12_00 e 172.16.16.152)
If nConP1200 # 0

	cQry :=" SELECT Z06_AMB FROM P12_00..Z06YY0 WHERE Z06_AMB LIKE '"+Left(cAmbiente,6)+"%' AND Z06_PROD = 'S' AND Z06_TES = 'S' "
	
	If TCSQLExec(cQry)<0
		MsgInfo("Ocorreu um problema na busca das informa��es no Amb. Adm P12_00!Favor abrir um chamado!","HLB BRASIL")
		Return
	EndIf
	...
	aArea := RestArea(aArea)
		...
		FOR i := 1 TO FCount()
			cCampo := FIELDNAME(I)       
			cAssunto :="Altera��o da TES  "+M->F4_CODIGO+  "  no Ambiente "+ Upper(cAmbiente) + " - Empresa : " + SM0->M0_NOME
