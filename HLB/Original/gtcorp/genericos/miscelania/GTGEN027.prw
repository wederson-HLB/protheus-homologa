...
Local cAte  	:= "   "   
	...
	DEFINE MSDIALOG oDlg TITLE "Cria indice/tabela" From 1,7 To 10,35 OF oMain     
        ...
        @ 037,025 BMPBUTTON TYPE 1 ACTION(If(Empty(cAte),MsgInfo("Necessario preencher o campo Ate","GT"),Processa({|| Process(cDe,cAte)},"Processando..."))) 
	...
	While SX2->(!EOF()) .And. SX2->X2_CHAVE <= cATe  
 	...
 	EndDo                                         
  	...
  	Else     
   		...
   		MsgInfo("Tabela(s) não encontrada(s)","GT")   
