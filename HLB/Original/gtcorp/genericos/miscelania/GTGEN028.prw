...
oDlg := MSDialog():New( aSize[7],0,aSize[6],aSize[5],"Grant Thornton Brasil - Manutenção de Menus",,,.F.,,,,,,.T.,,,.T. )
...
Next i            
If !lOkMenu
	MsgInfo("Não foi selecionado nenhum Menu!","Grant Thornton Brasil")
	Return .T.
EndIf
...
Next i
If !lOkMenu
	MsgInfo("Não foi selecionado nenhuma Tabela!","Grant Thornton Brasil")
	Return .T.
EndIf  
