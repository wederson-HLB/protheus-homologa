...
Local cTexto:=""
    ...
    //Cria o campo de sócio responsável no cadastro de clientes
    AltSF1(@cTexto)
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_OBRIGAT:=""
	SX3->X3_VLDUSER:=""
	SX3->X3_CBOX:="01=Dispensado Emissão Doc. Fiscal;02=Com Emissao Doc. Fiscal Autorizado Munic.;03=Sem Emissao Doc. Fiscal Embora Obrigatorio"
	SX3->X3_CBOXSPA:=""
	SX3->X3_CBOXENG:=""
	SX3->X3_INIBRW:=""
	SX3->X3_GRPSXG:=""
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_OBRIGAT:=""
	SX3->X3_VLDUSER:=""
	SX3->X3_CBOX:="T=Operação Normal;I=Imune;J=Iss Suspenso por Decisão Judicial"
	SX3->X3_CBOXSPA:=""
	SX3->X3_CBOXENG:=""
	SX3->X3_INIBRW:=""
	SX3->X3_GRPSXG:=""
