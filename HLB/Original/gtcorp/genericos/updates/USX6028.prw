...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do parametro para preenchimento de instruções bancárias para boletos GT.
Autor       : Guilherme Fernandes Pilan - GFP
Data/Hora   : 31/01/2017 - 15:41
Módulo      : UPDATE
*/
*---------------------*
User Function USX6028()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
For nR:=1 to len(aFils)
	If RecLock("SX6",!SX6->(DbSeek(aFils[nR]+"MV_P_00093")))
		SX6->X6_FIL		:= xFilial("SX6")
		SX6->X6_VAR     := "MV_P_00093"
		SX6->X6_TIPO    := "C"
		SX6->X6_DESCRIC := "Instrucoes para boleto"
		SX6->X6_CONTSPA := '{"1/2","S","2","2"}'
		SX6->X6_CONTENG := '{"1/2","S","2","2"}'
		SX6->X6_CONTEUD := '{"1/2","S","2","2"}'
		SX6->(MsUnLock())
		cTexto += "Atualizado Parametro MV_P_00093 para Filial: "+aFils[nR]+NL
	EndIf
Next nR
