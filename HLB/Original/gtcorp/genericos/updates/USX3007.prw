...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Atualização dos campos RA_ASODONT,RA_DPASSME,RA_TIPAMED,RA_TPASODO,RA_ASMEDIC para DIRF.
Autor       : Eduardo C. Romanini
Data/Hora   : 13/02/2011
*/
*---------------------*
User Function USX3007()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
Local aCampos := {"RA_ASODONT","RA_DPASSME","RA_TIPAMED","RA_TPASODO","RA_ASMEDIC"}
