...
Parametros  : Nenhum
Retorno     : Nenhum
Objetivos   : Criação de Parametros para Migração 11.8.
Autor       : Renato Rezende
Data/Hora   : 21/10/2014
Revisao     :
Obs.        :
*/  
*--------------------------------*
User Function USX6022()
*--------------------------------*  
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aAdd(aSX6, {"MV_SNIFOPE", "C"		,"Indica se o recurso SNIFFER esta operacional.1=Sim"	, "Indica si el recurso SNIFFER esta operativo.1=Si"	, "Indicates if the resource SNIFFER is operational."	, "2=Nao"		, "2=No"			, "1=Yes 2=No."			, ""		, ""			, ""			, "1"		   			   		, "1"		 					, "1"	   						,"U"		,"N"		})
