...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação dos Campos de _USERLGA/_USERLGI
...
While SubStr(Alltrim(SX2->X2_CHAVE),1,2) == "CV" .And. !SX2->(EOF())
	AADD(aSX3,{SubStr(Alltrim(SX2->X2_CHAVE),1,3),'',SubStr(Alltrim(SX2->X2_CHAVE),1,3)+'_USERGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','N','V','R'})
	AADD(aSX3,{SubStr(Alltrim(SX2->X2_CHAVE),1,3),'',SubStr(Alltrim(SX2->X2_CHAVE),1,3)+'_USERGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','N','V','R'})
...
While SubStr(Alltrim(SX2->X2_CHAVE),1,2) == "SN" .And. !SX2->(EOF())
	AADD(aSX3,{SubStr(Alltrim(SX2->X2_CHAVE),1,3),'',SubStr(Alltrim(SX2->X2_CHAVE),2,2)+'_USERLGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})
	AADD(aSX3,{SubStr(Alltrim(SX2->X2_CHAVE),1,3),'',SubStr(Alltrim(SX2->X2_CHAVE),2,2)+'_USERLGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})
	AADD(aArqUpd,SubStr(Alltrim(SX2->X2_CHAVE),1,3))
SX2->(dbSkip())
EndDo 
...
AADD(aSX3,{'SB1','','B1_USERLGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})     
AADD(aSX3,{'SB1','','B1_USERLGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})     
AADD(aArqUpd,'SB1')

AADD(aSX3,{'SE1','','E1_USERLGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})     
AADD(aSX3,{'SE1','','E1_USERLGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})
AADD(aArqUpd,'SE1')

AADD(aSX3,{'SE2','','E2_USERLGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})     
AADD(aSX3,{'SE2','','E2_USERLGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})
AADD(aArqUpd,'SE2')

AADD(aSX3,{'SE5','','E5_USERLGI','C','17','0','Log de Inclu','Log de Inclusao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})     
AADD(aSX3,{'SE5','','E5_USERLGA','C','17','0','Log de Alter','Log de Alteracao','€€€€€€€€€€€€€€ ','9','þA','L','S','V','R'})
AADD(aArqUpd,'SE5')
...
For i:=1 to len(aSX3)
	...
	Else
		cTexto += "Já existe no SX3 - o campo:"+aSX3[i][3]+NL
	EndIf
