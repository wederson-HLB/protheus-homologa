...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação de campo C5_P_IDER na tabela SC5 para armazenar o ID do Expense Report
Autor       : Guilherme Fernandes Pilan - GFP
Data/Hora   : 14/02/2017 - 16:10
Módulo      : UPDATE
*/
*---------------------*
User Function USX3071()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
Local aSX3    := {}
	...
	aAdd(aSX3,{"SC5","B3","C5_P_IDER"	,"C",12,0,"ID ER","ID ER","ID ER","ID Expense Report","ID Expense Report","ID Expense Report",""       ,''	,'€€€€€€€€€€€€€€ ',""  	,""      ,1,'’A',"","","U","S","V","R",'',"","","","","","","","","","N"})   
