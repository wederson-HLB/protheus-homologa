...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação do campo de gerente de conta, gerente contábil e sócio responsável
Autor       : Matheus Massarotto
Data/Hora   : 18/09/2014    10:14
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
Local cTexto:=""
    ...
    //Cria o campo de area no cadastro de centro de custo
    AltSA1(@cTexto)
...
Reclock("SX3",lIncSX3)
	...
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Ger Conta"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Ger Conta"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Gerente de Conta "
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Gerente de Conta "
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Gerente de Conta "
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_F3:="SRAOUT"
...
cTexto += "Incluido/alterados o campo A1_P_GECTA no SX3 da tabela SA1 "+NL
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="A1_P_NGCTA"
	SX3->X3_TIPO:="C"
	SX3->X3_TAMANHO:=100
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Nome Ger Cta"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Nome Ger Cta"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Nome Ger Cta"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Nome Gerente Conta"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Nome Gerente Conta"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Nome Gerente Conta"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_RELACAO:='IIF(INCLUI,"",U_GTSXB002(M->A1_P_GECTA))'
	SX3->X3_F3:=""
	SX3->X3_NIVEL:=0
	SX3->X3_RESERV:="þA"
	SX3->X3_TRIGGER:="S"
...
cTexto += "Incluido/alterados o campo A1_P_NGCTA no SX3 da tabela SA1 "+NL
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="A1_P_GECTB"
	SX3->X3_TIPO:="C"
	SX3->X3_TAMANHO:=11
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Ger Contabil"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Ger Contabil"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Ger Contabil"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Gerente Contabil"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Gerente Contabil"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Gerente Contabil"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_F3:="SRAOUT"
...
cTexto += "Incluido/alterados o campo A1_P_GECTB no SX3 da tabela SA1 "+NL
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="A1_P_NGCTB"
	SX3->X3_TIPO:="C"
	SX3->X3_TAMANHO:=100
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Nome Ger Con"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Nome Ger Con"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Nome Ger Con"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Nome Gerente Contabil"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Nome Gerente Contabil"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Nome Gerente Contabil"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_RELACAO:='IIF(INCLUI,"",U_GTSXB002(M->A1_P_GECTB))'
	SX3->X3_F3:=""
	SX3->X3_NIVEL:=0
	SX3->X3_RESERV:="þA"
	SX3->X3_TRIGGER:="S"
...
cTexto += "Incluido/alterados o campo A1_P_NGCTB no SX3 da tabela SA1 "+NL
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="A1_P_SORES"
	SX3->X3_TIPO:="C"
	SX3->X3_TAMANHO:=11
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Socio Respon"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Socio Respon"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Socio Respon"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Socio Responsavel"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Socio Responsavel"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Socio Responsavel"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_F3:="SRAOUT"
...
cTexto += "Incluido/alterados o campo A1_P_SORES no SX3 da tabela SA1 "+NL
...
Reclock("SX3",lIncSX3)
	...
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Nome Socio"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_RELACAO:='IIF(INCLUI,"",U_GTSXB002(M->A1_P_SORES))'
	SX3->X3_F3:=""
	SX3->X3_NIVEL:=0
	SX3->X3_RESERV:="þA"
	SX3->X3_TRIGGER:="S"
...
*--------------------------------*
Static Function ConsSRA(cTexto)
*--------------------------------*

DbSelectArea("SXB")
SXB->(DbSetOrder(1))
if SXB->(!DbSeek("SRAOUT"+"1"+"01"+"RE"))
	lIncSXB:=.T.
else
	lIncSXB:=.F.
endif          
Reclock("SXB",lIncSXB)
	...
	SXB->XB_SEQ:="01"
	SXB->XB_COLUNA:="RE"
	SXB->XB_DESCRI:="Consulta Socios Outs"
	if FieldPos("XB_DESCSPA")>0
		SXB->XB_DESCSPA:="Consulta Socios Outs"
	endif	
	if FieldPos("XB_DESCENG")>0
		SXB->XB_DESCENG:="Consulta Socios Outs"
	endif
	SXB->XB_CONTEM:="SRA"
	SXB->XB_WCONTEM:=""
SXB->(MsUnlock())	
...
Reclock("SXB",lIncSXB)
	...
	SXB->XB_CONTEM:="U_GTSXB007('SXB')"
	SXB->XB_WCONTEM:=""
SXB->(MsUnlock())

DbSelectArea("SXB")
SXB->(DbSetOrder(1))
if SXB->(!DbSeek("SRAOUT"+"5"+"01"+""))
	lIncSXB:=.T.
else
	lIncSXB:=.F.
endif          
Reclock("SXB",lIncSXB)
	...
	SXB->XB_CONTEM:="DADTRB->CPF"
	SXB->XB_WCONTEM:=""
SXB->(MsUnlock())

cTexto += "Incluido/alterados a consulta SRAOUT no SXB"+NL

Return


*-----------------------------*
Static Function AltSXA(cTexto)
*-----------------------------*
...
Reclock("SXA",lIncSXA)
	SXA->XA_ALIAS	:="SA1"
	SXA->XA_ORDEM	:="5"
	SXA->XA_DESCRIC	:="Responsaveis"
	if FieldPos("XA_DESCSPA")>0
		SXA->XA_DESCSPA:="Responsable"
	endif	
	if FieldPos("XA_DESCENG")>0
		SXA->XA_DESCENG:="Responsible"
	endif	
	SXA->XA_PROPRI	:= "U"
SXA->(MsUnLock())

cTexto += "Incluido/alterados a pasta Responsáveis no SXA para tabela SA1"+NL
...
AADD(aSX7,{"A1_P_GECTB","001","U_GTSXB002(M->A1_P_GECTB)","A1_P_NGCTB","P","N","","","","","U"})
AADD(aSX7,{"A1_P_SORES","001","U_GTSXB002(M->A1_P_SORES)","A1_P_NSRES","P","N","","","","","U"})
