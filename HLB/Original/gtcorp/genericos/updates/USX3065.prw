...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação dos campos de payroll
Autor       : Matheus Massarotto
Data/Hora   : 29/04/2016    10:14
Revisão		:                    
Data/Hora   : 
Módulo      : Genérico
*/
...
bCondicao := {|| X3_ARQUIVO == "SRV"}
DbSelectArea("SX3")
SX3->(DbSetOrder(1))
SX3->(DbSetFilter(bCondicao,"X3_ARQUIVO == 'SRV'"))
SX3->(DbGoBottom())
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="RV_PAYROLL"
	SX3->X3_TIPO:="L"
	SX3->X3_TAMANHO:=1
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Imp.Payroll?"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Imp.Payroll?"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Imp.Payroll?"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Imprime Payroll?"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Imprime Payroll?"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Imprime Payroll?"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_F3:=""
...
cTexto += "Incluido/alterados o campo RV_PAYROLL no SX3 da tabela SRV "+NL
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_CAMPO:="RV_DPAYROL"
	SX3->X3_TIPO:="C"
	SX3->X3_TAMANHO:=15
	SX3->X3_DECIMAL:=0
	if FieldPos("X3_TITULO")>0
		SX3->X3_TITULO:="Col. Payroll"
	endif
	if FieldPos("X3_TITSPA")>0
		SX3->X3_TITSPA:="Col. Payroll"
	endif
	if FieldPos("X3_TITENG")>0
		SX3->X3_TITENG:="Col. Payroll"
	endif
	if FieldPos("X3_DESCRIC")>0
		SX3->X3_DESCRIC:="Descricao Coluna Payroll"
	endif
	if FieldPos("X3_DESCSPA")>0
		SX3->X3_DESCSPA:="Descricao Coluna Payroll"
	endif
	if FieldPos("X3_DESCENG")>0
		SX3->X3_DESCENG:="Descricao Coluna Payroll"
	endif
	SX3->X3_PICTURE:="@!"
	SX3->X3_USADO:="€€€€€€€€€€€€€€ "
	SX3->X3_RELACAO:=''
...
cTexto += "Incluido/alterados o campo RV_DPAYROL no SX3 da tabela SRV "+NL
