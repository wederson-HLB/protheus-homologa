...
Parametros  : Nenhum
Retorno     : Nil
Objetivos   : Criação do Update : Projeto Controladoria - Impressao da Ordem de Pagamento
Autor       : Leandro Brito
Chamado		: 
Data/Hora   : 21/12/2015
*/
*---------------------*
User Function UZ22001()
*---------------------*
cArqEmp := "SigaMat.Emp"
__cInterNet := Nil
...
aAdd(aSX2,{"Z22",'\SYSTEM\','Z22'+cEmpAnt+'0' ,'Controle ID Imp. OP','Controle ID Imp. OP','Controle ID Imp. OP',""	,;
...
Aadd( aSix ,{ "Z22" , "1" , "Z22_FILIAL+Z22_CHAVE" , "Chave" , "Chave" , "Chave" , "U" , , "" , "S" } )
...
cOrdem := NextOrdem( 'Z22' )
aAdd(aSX3,{"Z22",cOrdem,"Z22_FILIAL"	   		,"C",2,0,"Filial"	,"Sucursal"	,"Branch"	,"Filial do Sistema"			,"Sucursal"	,"Branch of the System ","@!",'','€€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z22",cOrdem,"Z22_ID"	   		,"C",6,0,"ID"	,"ID"	,"ID"	,"ID"			,"ID"	,"ID","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"}) 

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z22",cOrdem,"Z22_CHAVE"	   		,"C",40,0,"Chave"	,"Chave"	,"Chave"	,"Chave"			,"Chave"	,"Chave","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})

cOrdem := Soma1( cOrdem )
aAdd(aSX3,{"Z22",cOrdem,"Z22_DATA"	   		,"D",8,0,"Data"	,"Data"	,"Data"	,"Data"			,"Data"	,"Data","@!",'','€€€€€€€€€€€€€€',"" ,"",0,'þA',"","","U","N","A","R",'',"","","","","","","","","","N"})
