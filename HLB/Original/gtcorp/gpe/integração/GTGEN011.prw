...
DEFINE MSDIALOG oDlg TITLE "Grant Thornton Brasil. - Integração Rb Serviços" FROM 00, 00 to 300, 380 PIXEL  
...
//		cQuery += " AND Z71_COD = '"+LEFT(cCmbTpPed,3)+"'"						+ Chr(13)
		...
		Do While TMPRB->(!EoF())     
			...
			cLinha4 := Stuff(cLinha4,109,113,STRZERO(VAL(STRTRAN(TRANSFORM(TMPRB->Z71_VALOR,"@E 999999.99"),",","")),8))//Valor
