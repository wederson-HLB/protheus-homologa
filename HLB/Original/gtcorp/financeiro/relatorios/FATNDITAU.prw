...
Aadd(aPergs,{"Tipo Fatura","","","mv_ch4","N",1,0,0,"C","","MV_PAR04","GT","","","","","KPMG","","","","","","","","","","","","","","","","","","","","","","",""})
...
//JSS - 10/04/2014 - Posiciona o SE1 para realizar a validação das contas. Chamado 00
dbSelectArea ("SE1")
DbGotop()
ProcRegua(RecCount())
DbSetOrder(1)
...
nJuros  := Round( (_nValor * 0,02),2) 
nMultaMensal:= Round( (_nValor * 0,02),2)   
...
If MV_PAR04 == 2
	...
	oPrn:Say (205,0010,"Beneficiario", oFont1, 100)
	oPrn:Say (205,0150,"Business Process Outsourcing Services Ltda", oFont4, 100)
	oPrn:Say (245,0150,"CNPJ 18.757.832/0001-12", oFont4, 100)
	...
	oPrn:Say (205,1070,"Agência/Código Beneficiario", oFont1, 100)
	oPrn:Say (250,1120,"0910/02585-7", oFont4, 100)
...
oPrn:Say (590,1250,Transform (aDadosTit[9], "@E 999,999,999,999.99"), oFont4, 100) //RRP - 26/07/2013 - Acréscimo e Decréscimo.
...
If MV_PAR04 == 2
	...
	oPrn:Say (0165 + _nAjuste,0010,"Beneficiario", oFont1, 100)
	...
	oPrn:Say (0165 + _nAjuste,1670,"Agência/Código Beneficiario",oFont1,100)
...
oPrn:Say (0405 + _nAjuste,0010,"Instruções (Todas as informações deste bloqueto são de exclusiva responsabilidade do Beneficiario)", oFont1, 100)
...
//If Alltrim(SM0->M0_CODIGO)$("Z4/CH/PN/MP/MQ/MW/MY/RH/Z8/ZP/") 	
	oPrn:Say (nLinha+1200,0100,aBolText[2]+" "+AllTrim(Transform(((aDadosTit[5]*0.01)/30),"@E 99,999.99")),oFont5)
/*Else 
   Alltrim(SM0->M0_CODIGO)$("ZB/ZF/") 
	oPrn:Say (nLinha+1200,0100,aBolText[2]+" "+AllTrim(Transform(((aDadosTit[5]*0.02)/30),"@E 99,999.99")),oFont5)
EndIf*/
