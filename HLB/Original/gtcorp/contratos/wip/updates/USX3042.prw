...
Parametros  : Nil                      
Retorno     : Nil
Objetivos   : Criação do campo de Area no Centro de Custo
...
*-----------------------------*
Static Function AltCTT(cTexto)
*-----------------------------*
Local lIncSX3	:= .F.

//<Inicio>Tratamento para buscar a ultima ordem
bCondicao := {|| X3_ARQUIVO == "CTT"}
DbSelectArea("SX3")
SX3->(DbSetOrder(1))
SX3->(DbSetFilter(bCondicao,"X3_ARQUIVO == 'CTT'"))
SX3->(DbGoBottom())
...
Reclock("SX3",lIncSX3)
	...
	SX3->X3_OBRIGAT:="€"
	SX3->X3_VLDUSER:=""
	SX3->X3_CBOX:="1=AUDITING;2=TAX;3=ADVISORY;O=OUTROS"
	SX3->X3_CBOXSPA:=""
	SX3->X3_CBOXENG:=""
	SX3->X3_INIBRW:=""
	SX3->X3_GRPSXG:=""
...
cTexto += "Incluido/alterados o campo CTT_P_AREA no SX3 da tabela CTT "+NL
